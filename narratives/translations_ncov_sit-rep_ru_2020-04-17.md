---
title: Геномный анализ распространения COVID-19. Ситуационный отчет 2020-04-17.
authors:
  - Sidney M. Bell
  - Emma Hodcroft
  - Cassia Wagner
...
abstract: "Этот еженедельный отчет использует общедоступные геномные данные для отслеживания распространения COVID-19. На этой неделе мы фокусируемся на вспышке в Соединенных Штатах. Для большинства областей США, мы находим свидетельства многочисленных ввозов -- как международного, так и внутреннего происхождения. Эти данные подчеркивают, что решения, сделанные каждым штатом, сильно влияют на судьбу других."
...
* [Справочные ресурсы](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-17?n=2).     
* [Об этих данных](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-17?n=3).
* [Обновления для Нью-Йорка](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-17?n=4).
* [Обновления для Калифорнии](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-17?n=7).
* [Обновления для Среднего Запада](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-17?n=8).
* [Обновления для Горных Штатов](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-17?n=9).
* [Что вы можете предпринять](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-17?n=10).
* [Благодарности](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-17?n=11).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Резюме

Мы провели анализ 1,347 общедоступных геномов SARS-CoV-2 из Соединенных Штатов. Сопоставив эти геномы вируса между собой, мы можем охарактеризовать, как SARS-CoV-2 перемещается по всему миру и распространяется локально. В обновлениях этой недели мы сообщаем:

* Вспышка в Нью-Йорке имеет космополитическое происхождение, но большинство случаев связаны с ввозами из Европы.
* Вспышка в Нью-Йорке демонстрирует смешивание случаев между всеми 5 районами.
* Вспышка в Калифорнии связана как с соседним штатом Вашингтон, так и с отдаленным Нью-Йорком.
* Вспышка на Среднем Западе неоднородна и является результатом многих независимых ввозов.
* Продолжающиеся вспышки в Юте и Айдахо тесно связаны.
* Решения, принятые каждым штатом, сильно влияют на судьбу других. Безопасное ослабление ограничений в любом штате потребует скоординированного сдерживания, когда действия всех штатов направлены на взаимную защиту.
...
# [Главный кластер в Нью-Йорке связан с Европейской вспышкой](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_division=Europe,New%20York&label=clade:A2&p=full&r=country)

Как вы могли уже видеть [в новостях на этой неделе](https://www.nytimes.com/2020/04/08/science/new-york-coronavirus-cases-europe-genomes.html), большинство вирусных образцов из Нью-Йорка (отображены в цвете) близко группируются с образцами из Европы (серый).
<br><br>
Нью-Йоркская ветвь одновременно обрамлена и переплетена с образцами из Европы, что утвердительно говорит о том, что ранние случаи были результатом заноса из Европы.
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 5-->
# [Многочисленные привнесения в Нью-Йорк](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree&f_division=Europe,New%20York,Asia&label=clade:A2&p=grid&r=location)

Большинство вспышек в Нью-Йорке начались с заноса (или заносов) из Европы. Но контекстные последовательности из других регионов мира позволяют нам наблюдать дополнительные заносы в Нью-Йорк. В соответствии с его космополитической природой, в Нью-Йорке мы можем найти случаи, родственные образцам из каждого другого региона мира.
<br><br>
Ранние случаи в Нью-Йорке наверняка представляют собой ввозные цепи передачи. Позднее, по мере развития вспышки, мы наблюдаем перемешивание между европейскими и Нью-Йоркскими образцами, что делает направление более поздних передач менее ясным.  
Как мы докладывали [на прошлой неделе](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-10?n=11), также наблюдается доказательство недавнего повторного заноса из США в Европу и Азию.
...
# [Перемешивание случаев из 5 районов Нью-Йорка](https://nextstrain.org/ncov/north-america/2020-04-17?c=location&d=tree,map&f_division=New%20York&f_location=Bronx,Brooklyn,Queens,Staten%20Island,Manhattan&label=clade:A2&p=full&r=location)

Внутри Нью-Йорка мы не видим значительного разделения случаев по районам. Это находится в согласии с частым перемешиванием случаев в пределах города.
...
У нас также есть доказательства многочисленных заносов между штатами. Например, случаи из Калифорнии охватывают генетическое разнообразие всего дерева, группируясь вместе с образцами как из соседнего штата Вашингтон, так и из Нью-Йорка. Это доказывает распространение между Калифорнией и как близлежащими, так и отдаленными штатами.
...
# [Вспышки на Среднем Западе были зарождены многочисленными ввозами](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_country=USA&f_division=Illinois,Indiana,Iowa,Kansas,Michigan,Minnesota,Nebraska,Ohio,Wisconsin&p=full&r=division)

Обратив внимание на последовательности из Среднего Запада США, мы видим, что случаи из этой области не образуют серию тесных кластеров, a, наоборот, распределены по всему дереву равномерно. Это говорит о том, что в этих штатах произошло много независимых ввозов, с несколькими различными цепочками передач, циркулирующими одновременно.
...
Также произошло несколько ввозов в Горные Штаты (Запад от Скалистых Гор). Увеличив эту часть дерева, мы видим хорошо различимую цепочку передач с несколькими последовательностями из Айдахо. Примечательно, что этот набор случаев окружен кластером случаев из Юты, демонстрируя тесную связь между этими двумя вспышками.
...
<br><br>
* Вспышка в Нью-Йорке демонстрирует перемешивание случаев между всеми 5 районами города.
<br><br>
...
<br><br>
* Вспышки в штатах Юта и Айдахо близкородственны, с продолжающейся передачей среди населения.
<br><br>
