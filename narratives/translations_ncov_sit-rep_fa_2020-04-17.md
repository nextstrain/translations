...
* [منابع پیش زمینه](https://nextstrain.org/narratives/ncov/sit-rep/fa/2020-04-17?n=2).     
* [درباره این داده‌ها](https://nextstrain.org/narratives/ncov/sit-rep/fa/2020-04-17?n=3).
* [به‌روزرسانی گزارش نیویورک](https://nextstrain.org/narratives/ncov/sit-rep/fa/2020-04-17?n=4).
* [به‌روزرسانی گزارش کالیفرنیا](https://nextstrain.org/narratives/ncov/sit-rep/fa/2020-04-17?n=7).
* [به‌روزرسانی گزارش ایالت‌های میانه غربی](https://nextstrain.org/narratives/ncov/sit-rep/fa/2020-04-17?n=8).
* [به‌روزرسانی گزارش غرب رشته‌کوههای راکی](https://nextstrain.org/narratives/ncov/sit-rep/fa/2020-04-17?n=9).
* [کارهایی که شما می‌توانید انجام دهید](https://nextstrain.org/narratives/ncov/sit-rep/fa/2020-04-17?n=10).
* [اعتبار علمی](https://nextstrain.org/narratives/ncov/sit-rep/fa/2020-04-17?n=11).
...
* شیوع‌های کنونی در ایالت‌های یوتاه و آیداهو به هم وابسته اند.
* تصمیم‌هایی که یک ایالت اتخاذ می‌کند، به شدت بر روی سرنوشت باقی ایالت‌ها هم تاثیرگذار است. پایان دادن امن به برخی محدودیت‌ها در هر ایالت، نیازمند مهار هماهنگ‌شده با تمامی ایالت‌ها برای حفاظت از یکدیگر است. 
...
#### Nextstrain منابع   
* [از این‌جا شروع کنید: چگونه درخت‌های ژنتیکی را بخوانید](https://nextstrain.org/narratives/trees-background/fa).  
* [پیش‌زمینه در مورد ویروس کرونا](https://nextstrain.org/help/coronavirus/human-CoV).
* [باور‌های متداول نادرست](https://nextstrain.org/narratives/ncov/sit-rep/fa/2020-03-13?n=11).
...
ما در حال حاضر از ۳۶ ایالت نمونه‌های توالی ژنتیکی داریم. این یک دست‌آورد باور نکردنی است چرا که نمونه‌گیری از توالی ژنتیکی یک ویروس بزرگ آر‌ان‌ای ناشناخته در وسط یک همه‌گیری جهانی دشوار است و فقط با تلاش باورنکردنی و به اشتراک‌گذاری به موقع داده‌ها توسط دانشمندان و پزشکان در سراسر جهان امکان‌پذیر است.
...
<br><br>
دسته ویروسی مرتبط با نیویورک، هم در کنار نمونه‌های توالی ژنتیکی اروپا و هم در میان آنها قرار گرفته‌اند. این بیان‌گر آن است که اغلب بیمارهای اولیه توسط افرادی که از اروپا آمده‌اند، مبتلا شدند.
<!-- There is no right side text -->
...
<br><br>
اولین بیماران در نیویورک نشان‌دهنده ابتلا توسط مسافران وارد شده به شهر هستند. با گذشت زمان، شاهد ادغام و ترکیب بسیاری از نمونه‌های اروپایی و نیویورکی بودیم که فهم و بررسی جهت انتقال را سخت کرده‌اند. همان‌طور که [هفته گذشته](https://nextstrain.org/narratives/ncov/sit-rep/fa/2020-04-10?n=11).
...
در شهر نیویورک، ما جدایی بسیار اندکی میان بیماران بر‌اساس منطقه جغرافیایی می‌بینیم. این نشان‌دهنده ادغام بیماران در تمام سطح شهر است.
...
با در نظر‌گرفتن نمونه‌های توالی ژنتیکی از ایالت‌های میانه غربی می توان گسترش همگن این نمونه‌ها به جای گروه شدن آن‌ها را در درخت مشاهده کرد. این بیانگر این است که تعداد کثیری معرف مستقل ویروس همراه با حلقه‌های مختلف انتقال در این ایالت‌ها وجود داشته‌است. 
