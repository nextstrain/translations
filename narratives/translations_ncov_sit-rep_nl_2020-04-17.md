---
title: Genomische analyse van COVID-19 verspreiding. Situatierapportage 2020-04-17.
authors:
  - Sidney M. Bell
  - Emma Hodcroft
  - Cassia Wagner
...
abstract: "Dit wekelijkse rapport gebruikt publiekelijk gedeelde genomische data om de verspreiding van COVID-19 te analyseren. Deze week focussen we op de uitbraak in de Verenigde Staten. Voor de meeste gebieden van de V.S. vinden we bewijs voor meerdere introducties -- van zowel internationale als binnenlandse origine. De data benadrukt dat de beslissingen, gemaakt door iedere staat, een enorme impact hebben op het lot van de andere staten."
...
* [Achtergrondbronnen](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-04-17?n=2).     
* [Over deze data](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-04-17?n=3).
* [Updates voor New York](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-04-17?n=4).
* [Updates voor Californië](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-04-17?n=7).
* [Updates voor het Midwesten](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-04-17?n=8).
* [Updates voor het Rocky Mountains Westen](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-04-17?n=9).
* [What u kunt doen](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-04-17?n=10).
* [Wetenschappelijk dankwoord](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-04-17?n=11).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Executive summary

We analyseerden 1.347 publiekelijk gedeelde SARS-CoV-2 genomen uit de Verenigde Staten. Door deze virale genomen met elkaar te vergelijken, kunnen we karakteriseren hoe SARS-CoV-2 zich wereldwijd beweegt en lokaal verspreidt. In de update van deze week, rapporteren we:  

* De uitbraak in New York heeft wereldwijde oorsprong, maar de meerderheid van de gevallen zijn toe te schrijven aan introducties vanuit Europa.    
* De uitbraak in de stad New York toont vermenging van gevallen vanuit alle vijf de stadsdelen.  
* De uitbraak in Californië is gerelateerd aan zowel het nabij gelegen Washington State als het ver gelegen New York. 
* De uitbraak in het Midwesten is heterogeen en is het resultaat van meerdere onafhankelijke introducties.
* Lopende uitbraken in Utah en Idaho zijn sterk gerelateerd.
* De beslissingen die door iedere staat gemaakt worden, beïnvloeden het lot van andere staten sterk. Het veilig versoepelen van maatregelen in een staat vraagt om gecoördineerde inperking, waarin elke staat handelt om de anderen te beschermen. 
...
# [COVID-19 Bronnen](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree&f_country=USA&p=full&r=division)
We hebben enkele bronnen voorbereid, die het interpreteren van de data die we presenteren in dit narratief makkelijker maken. 
#### Nextstrain Bronnen  
...
#### Externe Bronnen  
* [Vraag het een wetenschapper & FAQ (Engels)](https://covid19.fas.org/l/en).
* [WHO situatierapportage (Engels)](https://www.who.int/emergencies/diseases/novel-coronavirus-2019/situation-reports).
* [CDC Bronnen (Engels)](https://www.cdc.gov/coronavirus/2019-ncov/index.html).
* [De NYTimes COVID-19 bronnen (Engels)](https://www.nytimes.com/news-event/coronavirus).
...
# [Een opmerking over bemonstering](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=map&f_country=USA&p=full&r=division)
We hebben momenteel sequenties van monsters die genomen zijn in 36 staten. Dit is een ongelooflijke prestatie -- het sequencen van een onbekend, groot RNA-virus tijdens een pandemie is moeilijk, en is alleen mogelijk door het ongelooflijke werk en het tijdig delen van gegevens door wetenschappers en artsen over de hele wereld.
<br><br>
...
<br><br>
De kaart laat bijvoorbeeld weinig sequenties uit het centrum van de Verenigde Staten zien. Dit is NIET omdat COVID-19 niet in deze gebieden circuleert, of dat deze besmettingen niet net zo cruciaal zijn om te begrijpen. In tegendeel, we hebben simpelweg niet zoveel data beschikbaar vanuit deze gebieden. De grootte van iedere cirkel op de kaart geeft dan ook aan hoeveel data er beschikbaar is vanuit die regio, in plaats van de grootte van de uitbraak.
...
# [Belangrijkste New Yorkse clade gelinkt aan Europese uitbraak](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_division=Europe,New%20York&label=clade:A2&p=full&r=country)

Zoals u wellicht [in het nieuws deze week](https://www.nytimes.com/2020/04/08/science/new-york-coronavirus-cases-europe-genomes.html) hebt gezien, groeperen de meeste virale monsters uit New York (in kleur) zich dicht bij monsters uit Europa (grijs).
<br><br>
De New Yorkse clade is zowel geflankeerd door als verstrengeld met sequenties uit Europa, wat sterk suggereert dat de meeste vroege gevallen het gevolg zijn van introducties uit Europa.
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 5-->
# [Veel introducties in New York](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree&f_division=Europe,New%20York,Asia&label=clade:A2&p=grid&r=location)

Het grootste deel van de uitbraak in New York is ontstaan door Europese introductie(s). Maar de contextuele sequenties uit andere regio's van de wereld maken het mogelijk om extra introducties in New York City te zien. Trouw aan haar kosmopolitische karakter zijn er in New York gevallen die nauw verband houden met monsters uit alle andere regio's van de wereld.
<br><br>
De vroege gevallen in New York vertegenwoordigen waarschijnlijk binnenkomende transmissies. Later in de uitbraak zien we veel meer vermenging tussen Europese en New Yorkse monsters, waardoor de richting van latere transmissies minder duidelijk is. Zoals we [vorige week](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-04-10?n=11) rapporteerden, is er ook bewijs voor recente herintroducties vanuit de VS naar Europa en Azië.
...
# [Verstrengeling van gevallen uit alle 5 de stadsdelen van NYC](https://nextstrain.org/ncov/north-america/2020-04-17?c=location&d=tree,map&f_division=New%20York&f_location=Bronx,Brooklyn,Queens,Staten%20Island,Manhattan&label=clade:A2&p=full&r=location)

Binnen New York City zien we weinig afzondering van gevallen per stadsdeel. Dit komt overeen met een frequente vermenging van gevallen in de stad.
<!-- This is no right-side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 7-->
# [Uitbraak in Californië gelinkt aan zowel nabijgelegen als verre staten](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&f_division=California,New%20York,Washington&r=division&d=tree,map&legend=closed)

We zien ook bewijzen van meervoudige introducties tussen staten. Bijvoorbeeld, gevallen uit Californië omvatten de genetische diversiteit van de boom, gegroepeerd met monsters uit zowel de nabijgelegen staat Washington als New York. Dit is bewijs voor overdracht tussen Californië en zowel nabijgelegen als verafgelegen staten.
...
# [Uitbraken in het Midwesten werden door vele introducties gezaaid](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_country=USA&f_division=Illinois,Indiana,Iowa,Kansas,Michigan,Minnesota,Nebraska,Ohio,Wisconsin&p=full&r=division)

Als we de sequenties uit het Midwesten van de Verenigde Staten belichten, zien we dat de gevallen uit dit gebied gelijkmatig over de boom zijn verspreid, in plaats van dat ze een reeks hechte clusters vormen. Dit vertelt ons dat er veel onafhankelijke introducties in deze staten zijn geweest, waarbij meerdere verschillende transmissieketens tegelijkertijd in omloop zijn.
...
# [Verwante uitbraken over de Rocky Mountain West](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_country=USA&f_division=Idaho,Utah&label=clade:A2&m=div&p=full&r=division)

Er zijn ook verschillende introducties geweest in de Rocky Mountain West. Als we inzoomen, zien we een goed opgehelderde transmissieketen zich een weg banen over Idaho. Met name deze reeks gevallen wordt geflankeerd door een cluster van gevallen uit Utah, waaruit blijkt dat er een nauw verband bestaat tussen deze twee uitbraken.
...
* Blijf zoveel mogelijk thuis - vooral als je ziek bent; wees voorbereid met extra voorraden voor het geval je zelfquarantaine nodig hebt.  
...
* Financiële steun verlenen aan degenen die de gevolgen ondervinden van de maatregelen voor social distancing.
...
* Introducties uit Europa hebben het grootste deel van de uitbraak in New York veroorzaakt, maar er waren ook introducties uit andere delen van de wereld.
<br><br>
* Naarmate de uitbraak vordert, zien we ook aanwijzingen voor herintroducties vanuit de VS naar Europa en Azië.
<br><br>
* De uitbraak in New York City toont een vermenging van gevallen in alle 5 de stadsdelen.
<br><br>
* De uitbraak in Californië is gerelateerd aan zowel de nabijgelegen staat Washington als aan het verre New York.
<br><br>
* De Midwest-uitbraak is heterogeen, met meerdere transmissieketens die in de regio circuleren.
<br><br>
* Uitbraken in Utah en Idaho zijn nauw verwant, met voortdurende gemeenschapsoverdracht.
<br><br>
* De beslissingen die elke staat neemt, hebben een grote invloed op het lot van de andere staten. Voor een veilige versoepeling van de beperkingen in elke staat is een gecoördineerde inperking nodig, waarbij alle staten elkaar moeten beschermen.  
```
...
# [Wetenschappelijk verdienste](https://nextstrain.org/ncov/north-america/2020-04-17?d=map&c=author)

Wij willen onze erkentelijkheid betuigen voor het verbazingwekkende en tijdige werk dat is verricht door alle wetenschappers die bij deze uitbraak betrokken zijn, en met name door degenen die in China werkzaam zijn.
Alleen door het snel delen van genomische gegevens en metadata zijn dergelijke analyses mogelijk.

<br>

Wij erkennen ook [GISAID](https://gisaid.org) voor het leveren van het platform waar deze gegevens kunnen worden geüpload en gedeeld.
