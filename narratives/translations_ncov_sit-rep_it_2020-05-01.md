---
title: Analisi genomica della diffusione del COVID-19. Rapporto sulla situazione aggiornato al 1 maggio 2020.
authors:
  - Sidney Bell  
  - Nicola Müller
  - Cassia Wagner
...
date: 2020-May-01
abstract: "Questo rapporto usa sequenze genomiche virali pubblicamente condivise per tracciare la diffusione del COVID-19. Questa settimana, il rapporto è focalizzato sulle dinamiche dell'epidemia in Europa centrale e orientale."
---
...
# [Sommario](https://nextstrain.org/ncov/europe/2020-05-01?d=map&f_region=Europe&legend=closed)
...
* [Aggiornamenti sulla Repubblica Ceca](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-05-01?n=7).
<!--* [Updates for Turkey](https://nextstrain.org/narratives/ncov/sit-rep/2020-05-01?n=8).-->
* [Aggiornamenti sulla Turchia](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-05-01?n=8).
<!-- * [Updates for Poland](https://nextstrain.org/narratives/ncov/sit-rep/2020-05-01?n=9).-->
* [Aggiornamenti sulla Polonia](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-05-01?n=9).
<!-- * [Data from Hungary, Slovakia, Slovenia and Latvia](https://nextstrain.org/narratives/ncov/sit-rep/2020-05-01?n=10).-->
* [Dati da Ungheria, Slovacchia, Slovenia e Lettonia](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-05-01?n=10).
<!--* [What you can do](https://nextstrain.org/narratives/ncov/sit-rep/2020-05-01?n=11).-->
* [Cosa puoi fare](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-05-01?n=11).
<!--* [Scientific credit](https://nextstrain.org/narratives/ncov/sit-rep/2020-05-01?n=12).-->
* [Riconoscimenti scientifici](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-05-01?n=12).
...
Abbiamo analizzato 4442 genomi del virus SARS-Cov-2 condivisi pubblicamente. Confrontando questi genomi virali tra loro, possiamo tracciare come il virus SARS-CoV-2 si sta spostando nel mondo e si sta diffondendo all'interno delle comunità. Questa settimana il rapporto è focalizzato sull'Europa centrale e orientale, riportiamo:

<!-- * Many introductions to Russia-->
* Molte introduzioni del virus in Russia
<!-- * Heterogeneous outbreak in Moscow -->
* Focolai eterogenei a Mosca
<!--  * Majority of St. Petersburg outbreak tied to a single introduction, most likely from Western Europe   -->
* La maggior parte dei focolai di San Pietroburgo sono legati ad un'unica introduzione, molto probabilmente dall'Europa occidentale
<!-- * Extensive mixing of cases across Turkey following repeated travel-related introductions  -->
* Un mescolamento esteso dei casi attraverso la Turchia a seguito di ripetute introduzioni legate a viaggi
...
* Almeno 5 catene di trasmissione locale in Repubblica Ceca, molto probabilmente dovute a ripetute introduzioni del virus dall'Europa occidentale
<!-- * At least 11 separate introductions to Poland -->
* Almeno 11 separate introduzioni del virus in Polonia
<!--  * Early samples from Hungary, Latvia, Slovakia and Slovenia --> 
* Prime sequenze provenienti da Ungheria, Lettonia, Slovacchia e Slovenia
```
...
# [Risorse sul COVID-19](https://nextstrain.org/ncov/europe/2020-05-01?d=tree&f_region=Europe&legend=closed)
...
* [Come il SARS-CoV-2 muta e si diffonde](https://www.nytimes.com/interactive/2020/04/30/science/coronavirus-mutations.html).
<!--* [Ask a Scientist & FAQs](https://covid19.fas.org/).-->
* [Chiedi ad uno scienziato & domande frequenti](https://covid19.fas.org/).
...
* [Perché il coronavirus è cosi difficile da capire](https://www.theatlantic.com/health/archive/2020/04/pandemic-confusing-uncertainty/610819/).
...
# [Una nota sulla raccolta dei campioni](https://nextstrain.org/ncov/europe/2020-05-01?c=country&r=country&d=map&f_region=Europe&p=grid&legend=closed)
...
Ad esempio, la cartina mostra molte sequenze da Islanda, Regno Unito e Paesi Bassi. Ciò non indica necessariamente che il SARS-CoV-2 sta circolando più ampiamente in queste regioni; piuttosto che abbiamo più sequenze disponibili da queste nazioni. La dimensione di ogni cerchio sulla mappa indica quanti dati sono attualmente disponibili per quell'area, non la vera dimensione dell'epidemia.
...
# [Molteplici introduzioni del virus in Russia](https://nextstrain.org/ncov/europe/2020-04-29?c=division&d=tree,map&f_country=Russia&p=full&r=division)
...
Evidenziando i campioni raccolti in Russia, vediamo che sono sparsi sia geograficamente (su tutta la Russia) che genomicamente (lungo l'albero filogenetico).
<br><br>
...
Ciò indica che l'epidemia in Russia si è diffusa a partire da molte introduzioni separate, piuttosto che da una singola introduzione seguita da una diffusione interna alla nazione.
<br><br>
...
Anche se ci sono pochi campioni verso la parte bassa dell'albero che sono più strettamente collegati ai casi asiatici, la maggior parte delle sequenze russe discendono da sequenze europee. 
...
# [Focolai etereogenei a Mosca](https://nextstrain.org/ncov/europe/2020-04-29?c=division&d=tree&f_country=Russia&f_division=Moscow&label=clade:A2&p=full&r=division&m=div)

<!-- An example of frequent importation can be seen by zooming in on samples from Moscow.-->
Un esempio di importazione frequente del virus può essere visto ingrandendo sulle sequenze di Mosca.
<br><br>
...
Ci sono piccoli gruppi di casi che sono più strettamente collegati ad altre sequenze da Mosca, indicando una possibile trasmissione locale.
Comunque la maggior parte delle sequenze di Mosca sono più strettamente collegate a sequenze provenienti da altri luoghi, coerenti con l'ipotesi di importazioni del virus. 
<br><br>
...
Dato il numero di casi confermati a Mosca, è probabile che almeno alcune di queste introduzioni abbiano portato a un'ulteriore diffusione locale, ma non abbiamo ancora abbastanza sequenze per vederlo.
...
# [Ampio focolaio a San Pietroburgo, scoppiato all'inizio di marzo](https://nextstrain.org/ncov/europe/2020-04-29?c=division&d=tree&f_country=Russia&f_division=Saint-Petersburg&f_region=Europe&label=clade:A2&p=full&r=division)


<!-- We can look at St. Petersburg as a counterexample.-->
Possiamo considerare San Pietroburgo come un controesempio.
<br><br>
...
Come per Mosca, ci sono sequenze raccolte a San Pietroburgo lungo tutto l'albero, che indicano che ci sono state molteplici introduzioni del virus.
Al contrario, cliccando su "Esplora i dati da solo" e ingrandendo il gruppo principale al centro di questa visualizzazione, si può vedere un grande gruppo composto interamente da sequenze raccolte a San Pietroburgo.
<br><br>
...
Ciò è coerente con l'ipotesi che una di queste introduzioni a San Pietroburgo abbia innescato un focolaio in tutta la città, a partire dalla prima settimana di marzo. Questo grande focolaio è legato più strettamente a sequenze dall'Europa occidentale, sebbene non possiamo escludere la possibilità di trasmissione intermedia da altri luoghi di cui non abbiamo le sequenze. 
<!-- There is no right side text -->
...
# [Cinque catene di trasmissione locale in Repubblica Ceca](https://nextstrain.org/ncov/europe/2020-04-29?d=tree,map&f_country=Czech%20Republic&m=div&p=full)

<!-- The data from the Czech Republic show a mix of these two patterns.-->
Le sequenze dalla Repubblica Ceca mostrano un mescolamento di questi due pattern. 
<br><br>
...
Ci sono almeno 7 casi dove una sequenza isolata in Repubblica Ceca discende da un virus che stava, molto probabilmente, circolando altrove in Europa, indicando nuove introduzioni tra il primo marzo e il 2 aprile. 
<br><br>
...
Per 5 di queste introduzioni, osserviamo anche casi locali strettamente correlati, raccolti in tempi diversi. Ciò è coerente con l'ipotesi di un focolaio locale.
<br><br>
...
Da questo, possiamo concludere che ci sono state almeno 7 introduzioni del virus nella Repubblica Ceca; almeno 5 di queste hanno probabilmente dato luogo a focolai locali.
...
# [Estensivo mescolamente dei casi attraverso la Turchia](https://nextstrain.org/ncov/europe/2020-04-29?c=country_exposure&d=tree,map&f_country=Turkey&label=clade:A2&p=full&r=division)
...
Nella parte centrale dell'albero, osserviamo una serie di sequenze provenienti da molte province diverse della Turchia.
Alcuni di questi casi hanno riportato una storia di viaggi dall'Arabia Saudita, dando succesivamente luogo a casi strettamente collegati tra loro in Turchia.
<br><br>
...
Normalmente, potremmo supporre che i viaggiatori di ritorno abbiano passato il virus ai membri della famiglia o ai vicini a casa.
È interessante notare, tuttavia, che le sequenze dei viaggiatori sono state spesso raccolte da province diverse rispetto ai casi più strettamente correlati.
<br><br>
...
Ciò indica che c'è stato un mescolamento estensivo di diversi ceppi virali, che hanno raggiunto molte provincie della Turchia in una settimana. 
Queste osservazioni potrebbero anche essere spiegate dall'eventualità di un grande assembramento di persone, sebbene avremmo bisogno di maggiori dati epidemiologici per indagare ulteriormente. 
<!-- There is no right-side text -->
...
# [Almeno 11 introduzioni in Polonia](https://nextstrain.org/ncov/europe/2020-04-29?d=tree,map&f_country=Poland&p=full&legend=closed)
...
Abbiamo 15 sequenze provenienti dalla Polonia su Nextstrain. Di queste 15, almeno 11 rappresentano introduzioni separate del virus da altre parti del mondo.
Come a Mosca, dato il numero di casi riportati, potremmo aspettarci che diverse di queste introduzioni abbiano dato inizio a catene di trasmissione locale in Polonia, ma ancora non siamo in grado di osservarlo nei dati genomici.
<!-- There is no right-side text -->
...
# [Primi campioni dall'Ungheria, Lettonia, Slovacchia e Slovenia](https://nextstrain.org/ncov/europe/2020-04-29?d=tree,map&f_country=Hungary,Latvia,Slovakia,Slovenia&f_region=Europe&p=full&legend=closed)
...
A marzo, 20 sequenze virali sono stata condivise dall'Ungheria, Lettonia, Slovacchia e Slovenia. 
Anche se non disponiamo ancora di dati sufficienti da questi Paesi per trarre conclusioni definitive, apprezziamo questi primi sforzi e continueremo a monitorare i dati in arrivo.
<!-- There is no right-side text -->
...
#### Il SARS-COV-2 è stato introdotto in Russia diverse volte; i focolai a Mosca sono altamente eterogenei.
<br><br>
...
#### Ci sono state introduzioni multiple a San Pietroburgo. Una di queste introduzioni, dall'Europa occidentale all'inizio di marzo, ha dato luogo a un grande focolaio di casi trasmessi localmente. 
<br><br>
...
#### A seguito di ripetute introduzioni legate a viaggi, c'è stato un esteso e rapido mescolamento dei ceppi virali in tutta la Turchia.
<br><br>
<!-- #### There are at least 5 local transmission chains circulating across the Czech Republic. --> 
#### Ci sono almeno 5 catene di trasmissione locale che stanno circolando in Repubblica Ceca.
<br><br>
<!--  #### There have been at least 11 separate introductions of the virus to Poland.--> 
#### Ci sono state almeno 11 introduzioni separate del virus in Polonia.
<br><br>
...
#### Abbiamo ricevuto le prime sequenze da Ungheria, Lettonia, Slovacchia e Slovenia. Sebbene non disponiamo ancora di dati sufficienti per trarre conclusioni, continueremo a monitorare e forniremo aggiornamenti il prima possibile. 
```
...
# [Riconoscimenti scientifici](https://nextstrain.org/ncov/2020-05-01?d=map&c=author)
...
La lista delle specifiche sequenze fornite da ogni laboratorio sono [elencate qui](https://github.com/nextstrain/ncov/blob/e8020ca13e420bb62e31acf9a07268bc08b11c63/narratives/sit-rep_credits.md).
<br><br>
