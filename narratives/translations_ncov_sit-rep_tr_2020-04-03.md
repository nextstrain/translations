...
* [Arka plan kaynakları](https://nextstrain.org/narratives/ncov/sit-rep/tr/2020-04-03?n=2).     
* [Örneklem hakkında bir not](https://nextstrain.org/narratives/ncov/sit-rep/tr/2020-04-03?n=3).
* [Afrika'dan güncellemeler](https://nextstrain.org/narratives/ncov/sit-rep/tr/2020-04-03?n=4).
* [Asya'dan güncellemeler](https://nextstrain.org/narratives/ncov/sit-rep/tr/2020-04-03?n=7).
* [Avrupa'dan güncellemeler](https://nextstrain.org/narratives/ncov/sit-rep/tr/2020-04-03?n=9).
* [Kuzey Amerika'dan güncellemeler](https://nextstrain.org/narratives/ncov/sit-rep/tr/2020-04-03?n=12).
* [Ne yapabilirsiniz](https://nextstrain.org/narratives/ncov/sit-rep/tr/2020-04-03?n=15).
* [Bilimsel Katkılar](https://nextstrain.org/narratives/ncov/sit-rep/tr/2020-04-03?n=16).
...
Japonya'ya gerçekleşen yakın tarihli virüs girişleri yolcu gemisi ile ilişkililer.
...
**Dünyadaki diğer bölgeler**
<br>
Ayrıca Güney Amerika ve Okyanusya'dan yeni viral genomlar aldık. Bu yeni örneklerin çoğu, filogenetik ağaca yayılmış ve dünyanın diğer bölgelerinde toplanan örnekler ile gruplanmış halde. Fakat, elimizde bunları bir bağlama oturtabilecek daha fazla veri olmadan bu yeni diziler hakkında çıkarımlarda bulunamayız.
<br><br>
Bu bölgelerde ek veri üretmek üzere çalışan grupları takdir ediyoruz. Daha spesifik çıkarımlar mümkün hale geldikçe bulgularımızı paylaşacağız.
```
...
[Filogenetik ağaçları nasıl yorumlamalı](https://nextstrain.org/narratives/trees-background/tr)?
...
# [Afrika'dan güncellemeler](https://nextstrain.org/ncov/2020-04-03?d=tree,map&f_region=Africa&p=grid&r=division)

Bu hafta Senegal ve Demokratik Kongo Cumhuriyeti'nden yeni güncellemelerimiz var.
Ancak bu, Afrika'nın başka bölgelerinde COVID-19 vakalarının olmadığını göstermiyor; sadece bu bölgelerde belli çıkarımlar yapabilmek için yeterli verimiz var.
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 5-->
# [Senegal'de dolaşım halinde olan iki yerel bulaşı zinciri](https://nextstrain.org/ncov/2020-04-03?c=division&d=tree&f_country=Senegal&f_region=Africa&label=clade:A2a&p=grid&r=division)

Burada, Senegal'den iki küme halinde vakalar görüyoruz. Bu kümelerin birlikte gruplanmıyor olmaları en az iki virüs girişinden kaynaklı olduğunu gösteriyor. Bu kümelerin her biri, kısa bir süre zarfı içinde örneklenmiş yakından ilişkili vakalardan oluşuyor. Bu da yerel bulaşıda görülen durumla bağıntılı.
<br><br>
Ağacın yukarı kısımlarında gösterilen küme 28 Şubat ile 4 Mart arasında Dakar'dan örneklenmiş vakaları gösteriyor.
Bu da hCOV-19'un en az 1 aydır Dakar'da yerel bir dolaşım halinde olduğunu gösteriyor.
<br><br>
Ağacın ortasında, 10 - 12 Mart arasında Touba'dan örneklenmiş vakalardan oluşan bir küme var.
Bu da hCoV-19'un Touba'da yaklaşık 3 haftadır dolaşım halinde olduğunu gösteriyor.
<!-- There is no right side text -->

<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 6-->
# [Demokratik Kongo Cumhuriyeti'nde devam eden yerel bulaşı](https://nextstrain.org/ncov/2020-04-03?c=division&d=tree&f_country=Congo&f_recency=3-7%20days%20ago&label=clade:A2a&p=grid&r=division)
Bu hafta, Kinşasa, Demokratik Kongo Cumhuriyeti'nden 8 yeni genom dizisi elimize ulaştı.
<br><br>
Yeni örneklerin 1 tanesi hariç tümü yerel salgın soyhattı (klad) ile gruplanıyor. [Bundan geçen haftanın raporunda bahsettik](https://nextstrain.org/narratives/ncov/sit-rep/tr/2020-03-27?n=16).
Bu, Demokratik Kongo Cumhuriyeti içinde devam eden yerel bulaşının olduğunu ve salgının kontrol altına alınması için hızlı önlem alınması gerektiğini göstermektedir.



<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 7-->
# [Asya'dan güncellemeler](https://nextstrain.org/ncov/2020-04-03?d=tree,map&f_region=Asia&p=grid)
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 8-->
# [Japonya’ya yakın zaman önce olan girişler yolcu gemisiyle ilişkilidir](https://nextstrain.org/ncov/2020-04-03?f_country=Japan&label=clade:A2a&m=div&d=tree,map)

Japonya'dan yakın zaman önce gelen 16 dizinin 10 tanesi Nil Nehri gezisine katılmıştır. Teşhis konduktan sonra Japonya'dan örneklenen 16 genom dizisi 2 kümeye bölünmüştür. İlginç olarak bu kümelerin Japonya ya da Asya'daki genom dizileriyle bağlantısı yok. Ancak bu diziler başlıca Birleşik Devletler ve Avrupa'da görülen kümeler içinde yer almaktadır.
<br><br>
Buradan hareketle, bu Japon yolculara Mısır’ı ziyaretleri sırasında karşılaştıkları Avrupalı ve Amerikalılardaki suşların bulaşmış olması muhtemel. Genom dizileri, yolcular Japonya’ya döndükten sonra Mart ayının ortasında elde edildiğinden, bu durum Avrupa ve Birleşik Devletler’de dolaşımda olan varyantların Mart ayının başında küresel yolculuk nedeniyle dünyaya yayıldığında kanıt oluşturmaktadır.
<!-- There is no right side text -->
...
# [Avrupa'ya ilişkin güncellemeler](https://nextstrain.org/ncov/2020-04-03?d=tree,map&f_region=Europe&p=grid)
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 10-->
# [İzlanda'da yapılan çok sayıdaki genom dizilemesi seyahat ilişkili yayılmanın boyutlarını ortaya koymaktadır](https://nextstrain.org/ncov/2020-04-03?c=country_exposure&f_country=Iceland&p=grid&d=tree,map&legend=open)

Yakın bir zaman önce İzlanda'daki [doğrulanmış vakaların](https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200402-sitrep-73-covid-19.pdf) %25’inden gelen 301 genom dizisi elimize ulaştı.
<br><br>
Her örneği kayıt edilmiş seyahat tarihine göre renklendirdiğimizde bu bulaşmaların yaklaşık olarak yarısının İzlanda'nın dışında gerçekleştiğini görmekteyiz. Geriye kalan yarısının da yerel olarak gerçekleşen bulaşmalar olduğu varsayılmaktadır (gri renkle gösterilmiştir).
<br><br>
Bu durum, [geçen hafta da bildirdiğimiz](https://nextstrain.org/narratives/ncov/sit-rep/tr/2020-03-27?n=5) gibi Avrupa'da her ülkede ortaya çıkmış salgınlar arasında ne derecede karışma olduğunu ortaya koymaktadır. Verilen herhangi bir virüs örneğinin atasının nerede olmuş olabileceğine ilişkin yorumlar yapabiliriz ancak örnek alınmamış bölgeler aracılığıyla gerçekleşen dolaylı bulaşmalar olabileceğini de göz ardı edemeyiz.
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 11-->
# [Seyahat geçmişleri Avusturya'daki yerel bulaşmaları ortaya çıkartmaktadır](https://nextstrain.org/ncov/2020-04-03?c=country_exposure&d=tree,map&f_country=Iceland&f_country_exposure=Austria&m=div&p=full)

Bu durum aynı zamanda bir ülkede yapılan kapsamlı dizileme çabalarının ve seyahat geçmişi kayıtlarının tutulmasının,  henüz genom dizisi elde edilmemiş olsa bile başka bir yerdeki yerel durumu anlamamıza nasıl yardım ettiğine ilişkin güçlü bir örnek sunmaktadır.
<br><br>
Avusturya'ya seyahat ettiği bildirildikten sonra İzlanda'da genom dizisi elde edilmiş vakalara baktığımızda, kısa bir zaman zarfı içerisinde dizilenmiş olan birbiriyle yakın ilişkili Avusturya vakalarının oluşturduğu kümeleri görmekteyiz.
Bu tablo daha çok Avusturya’ya pek çok girişin söz konusu olduğu bir senaryoyla uyumludur. Birbiriyle ilişkili dizilerin Avusturya’da topluluk bulaşmasını mı yoksa aynı virüs suşuna maruz kaldıktan sonra bağlantılanan seyahat partnerlerini mi ortaya koyduğundan emin olamayız.
<br><br>
Avrupa'nın farklı ülkeleri arasındaki gri renkle gösterilen bağlantıların sayısı dikkat çekicidir. Avrupa'daki ülkelerin büyük bir kısmı çoklu girişe maruz kalmış gibi görünmektedir. Dolayısıyla virüsün Avrupa çapında nasıl yayıldığına ilişkin basit bir senaryodan söz edilemez. Virüs muhtemelen haftalar öncesinde geniş ölçüde yayılmaktaydı.



<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 12-->
# [Kuzey Amerika'ya ilişkin güncellemeler](https://nextstrain.org/ncov/2020-04-03?d=tree,map&f_region=North%20America&p=grid&legend=closed)
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 13-->
# [Birleşik Devletler’deki yaygın karışma](https://nextstrain.org/ncov/2020-04-03?c=division&f_country=USA&m=div&r=location&d=tree,map&legend=closed)

Birleşik Devletler’deki salgına ilişkin tablonun tamamını görmeye başladıkça bu yerel salgınların büyük ölçekte gerçekleşen karışmaların bir sonucu olduğu da daha açık hale gelmektedir.
<br><br>
Daha önceki vakaların çoğu seyahatle ilişkiliyken, pek çok eyaletten gelen daha yakın zamanlı vakalar birbiriyle tüm ağaç boyunca karışmış durumdadır.    
<br><br>
Bu da, bu salgını durdurmak için ortak bir strateji ortaya koymanın hayati önem taşıyacağını ortaya koymaktadır.
<!-- This is no right-side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 14-->
# [Ontario'da dolaşımda olan iki yerel bulaşma zinciri](https://nextstrain.org/ncov/2020-04-03?f_division=Ontario&label=clade:B1&d=tree,map&c=division)

Burada Ontario’dan elde edilen dizilerin iki kümesini görmekteyiz. Bu kümeler birlikte gruplanmıyor ve her bir küme başka ülkelerden gelen örneklerin yakınında yer alıyor. Bu da, bunların iki ayrı virüs girişin sonucu olduğuna işaret etmektedir.
<br><br>
Öte yandan her bir küme içindeki bu vakaların her biri Ontario’daki  diğer vakalarla yakın ilişkilidir. Bu da, bunun yüksek ihtimal ile yerel bir bulaşım olduğuna işaret etmektedir.
<br><br>
Buradan hareketle Ontario'da en az 3 Mart'tan itibaren süregelen bir yerel bulaşmanın söz konusu olduğu çıkarımını yapabiliriz.
<br><br>
İlginç olarak, ağaçtaki Ontario örnekleri çevreleyen dizilerin büyük bir kısmı Birleşik Devletler’den gelmektedir. Bu da iki ülke arasında önemli ölçüde karışma olduğuna işaret etmektedir.
<!-- There is no right side text -->
...
<br><br>
#### Senegal ve Demokratik Kongo Cumhuriyeti'nde yerel bulaşının olduğuna dair kanıtlar bulduk. Bu hassas bölgelerde salgını önlemek için acil önlemler alınması gerekmektedir. Afrika'nın diğer bölgelerindeki durumu değerlendirmek için hala yeterli veriye sahip değiliz.
<br><br><br>
#### Yakın geçmişte Japonya'ya gerçekleşen virüs girişleri yolcu gemisiyle ilişkilidir.
<br><br><br>
#### İzlanda'dan gelen çok sayıdaki genom verisi seyahat ilişkili yayılımın boyutuna dikkat çekmekte ve Avustralya'da muhtemel bir yerel bulaşı olduğunu ortaya koymaktadır.
<br><br><br>
#### Amerika Birleşik Devletleri'ndeki vakalar ağaç üzerinde iç içe yer almaktadır, bu da eyaletler arası geniş bir bulaşıya işaret etmektedir. Bunun yanında A.B.D-Kanada arasında da bir karışma olduğuna ve Ontario'da bir yerel bulaşma olduğuna dair kanıtlar da vardır.
```
...
# [Bilimsel Katkılar](https://nextstrain.org/ncov/2020-04-03?d=map&c=author)
...
Ayrıca, bu verilerin yüklenebileceği ve paylaşılabileceği platformu sağladığı için [GISAID'e](https://www.gisaid.org/) minnettarlıkla teşekkür ederiz.
