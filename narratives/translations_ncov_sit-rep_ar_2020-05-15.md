...
<br><br>
تصيب الفيروسات الخلايا لأنها تحتاج لأن تقترض الاليات الخلوية من أجل أن تتضاعف. هذه العملية بالنسبة لفيروسات RNA هي مرتبطة تحدث فيها أخطاء بشكل شائع، حيث أن معظم انزيمات بلمرة RNA ( وهي الالات الخلوية التي تستخدم لبناء نسخ جديدة من RNA) غير قادرة على تدقيق القراءة وتصحيح اعمالها. وهذا سيقود الى طفرات متكررة في الجينوم الفيروسي: وهذا طبيعي ومتوقع.
<br><br>
