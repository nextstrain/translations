...
* [Справочные ресурсы](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-03?n=2).     
* [Заметка о сборе образцов](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-03?n=3).
* [Последние данные по Африке](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-03?n=4).
* [Последние данные по Азии](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-03?n=7).
* [Последние данные по Европе](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-03?n=9).
* [Последние данные по Северной Америке](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-03?n=12).
* [Что вы можете предпринять](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-03?n=15).
* [Благодарности](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-04-03?n=16).
...
<br><br>
Если вы не знакомы с филогенетическими деревьями, мы рекомендуем вам ознакомиться с [брошюрой 'Как читать филогенетические деревья'](https://nextstrain.org/narratives/trees-background/ru) и вернуться, когда вы чувствуете себя подготовленными.
<!-- This is right-side text -->
```auspiceMainDisplayMarkdown

## Nextstrain Ресурсы

[Как читать филогенетические деревья](https://nextstrain.org/narratives/trees-background/ru).  
...
[Наш Мир в Данных](https://ourworldindata.org/coronavirus).
...
# [Заметка о сборе образцов](https://nextstrain.org/ncov/2020-04-03?c=country&r=country&d=map&p=grid&legend=closed)
...
На этой неделe у нас есть обновленные данные по ситуации в Сенегале и Демократической Республике Конго.
...
Это говорит о том, что hCov-19, вероятно, локально циркулирует в Дакаре уже, как минимум, на протяжении месяца.
<br><br>
...
<br><br>
Все новые образцы кроме одного кластеризуются с местными очагами вспышки, о которых [мы сообщали на прошлой неделе](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=16).
...
# [Обширное секвенирование в Исландии подчеркивает степень распространения, связанного с поездками](https://nextstrain.org/ncov/2020-04-03?c=country_exposure&f_country=Iceland&p=grid&d=tree,map&legend=open)
...
<br><br>
Как мы [сообщали на прошлой неделе](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=5), это подчеркивает, как много смешиваний произошло между вспышками в каждой европейской стране.
...
# [Истории поездок раскрывают локальную передачу в Австрии](https://nextstrain.org/ncov/2020-04-03?c=country_exposure&d=tree,map&f_country=Iceland&f_country_exposure=Austria&m=div&p=full)
...
<br><br>
Основываясь на случаях, секвенированных в Исландии после поездки в Австрию, мы видим множество кластеров, тесно связанных с австрийскими случаями, полученных за короткий промежуток времени.
...
Мы также хотели бы поблагодарить [GISAID](https://www.gisaid.org/) за предоставление платформы, через которую эти данные могут быть загружены и распространены.
