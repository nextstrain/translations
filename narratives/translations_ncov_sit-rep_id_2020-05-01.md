---
title: Analisis genomik penyebaran COVID-19. Laporan keadaan per 01-05-2020.
authors:
  - Sidney Bell  
  - Nicola Müller
  - Cassia Wagner
...
date: 1 Mei 2020
abstract: "Laporan mingguan ini menggunakan data genomik yang dibagikan secara publik untuk melacak wabah COVID-19. Pekan ini, kami fokus pada dinamika wabah di Eropa Tengah dan Timur."
---
...
# [Daftar Isi](https://nextstrain.org/ncov/europe/2020-05-01?d=map&f_region=Europe&legend=closed)
...
* [Apa yang Anda dapat lakukan](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-05-01?n=11).
* [Pengakuan ilmiah](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-05-01?n=12).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Ringkasan

Kami menganalisis 4.442 genom COVID-19 yang tersedia untuk publik. Dengan memperbandingkan genom virus ini, kami dapat mengkarakterisasi bagaimana COVID-19 bergerak di seluruh dunia dan menyebar secara lokal. Dalam pembaruan pekan ini, kami fokus pada Eropa Tengah & Timur dan melaporkan:

* Introduksi berulang ke Rusia
* Perebakan heterogen di Moskwa
* Mayoritas perebakan di Sankt-Peterburg terkait dengan satu introduksi, kemungkinan besar dari Eropa Barat
* Percampuran yang luas kasus-kasus di Turki setelah introduksi berulang yang terkait perjalanan
* Setidaknya 5 rantai penularan lokal di Republik Ceko, kemungkinan besar karena introduksi berulang dari Eropa Barat
* Setidaknya 11 kali introduksi ke Polandia
* Sampel awal dari Hongaria, Latvia, Slowakia, dan Slovenia  
```
...
# [Informasi mengenai COVID-19](https://nextstrain.org/ncov/europe/2020-05-01?d=tree&f_region=Europe&legend=closed)
...
* [Bagaimana SARS-CoV-2 bermutasi dan menyebar](https://www.nytimes.com/interactive/2020/04/30/science/coronavirus-mutations.html).
...
* [Mengapa koronavirus ini sangat membingungkan](https://www.theatlantic.com/health/archive/2020/04/pandemic-confusing-uncertainty/610819/).
...
# [Catatan mengenai sampling](https://nextstrain.org/ncov/europe/2020-05-01?c=country&r=country&d=map&f_region=Europe&p=grid&legend=closed)
Saat ini kami memiliki sekuens dari sampel yang diambil di 6 benua. Ini adalah raihan luar biasa -- melakukan sekuensing virus RNA besar dan belum dikenal di tengah-tengah pandemi merupakan hal yang sulit, dan hanya mungkin dilakukan melalui kerja luar biasa dan pembagian data yang tepat waktu oleh para ilmuwan dan dokter di seluruh dunia.
<br><br>
...
<br><br>
Sebagai contoh, peta di samping menunjukkan banyak sampel dari Islandia, Inggris, dan Belanda. Ini tidak harus berarti bahwa SARS-CoV-2 beredar lebih luas di daerah ini; melainkan, kami hanya memiliki lebih banyak data yang tersedia dari negara-negara tersebut. Ukuran setiap lingkaran pada peta menunjukkan berapa banyak data yang saat ini tersedia dari wilayah itu, bukan ukuran wabah sebenarnya.
...
<br><br>
Ini menunjukkan bahwa wabah di Rusia dipicu oleh banyak introduksi terpisah, dan bukan oleh introduksi tunggal yang diikuti penyebaran dalam negeri.
<br><br>
Walaupun ada beberapa sampel di bagian bawah pohon yang berkaitan paling erat dengan kasus-kasus Asia, sebagian besar sampel Rusia berasal dari garis keturunan Eropa.
...
<br><br>
Ada beberapa klaster kasus yang terkait paling dekat dengan sampel lain dari Moskwa, menunjukkan kemungkinan adanya penularan lokal.
Namun demikian, sebagian besar sampel dari Moskwa terkait paling dekat dengan sampel dari tempat lain, menunjukkan terjadinya importasi.
<br><br>
Mengingat jumlah kasus terkonfirmasi di Moskwa, boleh jadi ada beberapa introduksi ini yang menyebabkan penyebaran lokal lebih lanjut, tetapi kami belum memiliki cukup data untuk melihatnya.
...
<br><br>
Seperti halnya Moskwa, sampel dari Sankt-Peterburg tersebar di seluruh pohon, yang menunjukkan ada beberapa kali introduksi.
Sebaliknya, jika Anda meng-klik 'Explore the Data Yourself' ('Jelajahi Data Sendiri') dan memperbesar klaster utama di tengah tampilan ini, kita dapat melihat klaster besar yang seluruhnya terdiri dari sampel-sampel Sankt-Peterburg.
<br><br>
Pola ini menunjukkan bahwa salah satu introduksi ke Sankt-Peterburg memicu penularan luas di seluruh kota, mulai sekitar minggu pertama bulan Maret. Klaster perebakan besar ini terkait paling dekat dengan sampel-sampel dari Eropa Barat, meskipun kami tidak dapat mengesampingkan kemungkinan penularan perantara di tempat lain yang tidak diambil sampelnya.
<!-- There is no right side text -->
...
<br><br>
Setidaknya ada 7 kali kejadian di mana sampel yang diisolasi di Republik Ceko merupakan keturunan dari virus yang kemungkinan besar beredar di tempat lain di Eropa, menunjukkan introduksi baru antara 1 Maret dan 2 April.
<br><br>
Pada 5 dari introduksi ini, kami juga melihat kasus-kasus lokal yang terkait erat, disampel dari waktu ke waktu. Ini menunjukkan terjadinya penularan lokal.
<br><br>
Dari sini, kita dapat mengatakan bahwa setidaknya ada 7 kali introduksi ke Republik Ceko; setidaknya 5 di antaranya kemungkinan mengakibatkan penularan lokal lebih lanjut.
...
<br><br>
Normalnya, kita dapat berasumsi bahwa pelancong yang pulang telah menularkan virus kepada anggota rumah tangga atau tetangganya.
Akan tetapi, menariknya, kasus-kasus para pelancong ini sering diambil sampelnya dari provinsi-provinsi yang berbeda dari kasus-kasus yang paling terkait dengannya.
<br><br>
Ini menunjukkan bahwa telah ada percampuran garis keturunan virus yang luas, mencapai banyak provinsi Turki dalam waktu satu minggu. Kita juga dapat berspekulasi bahwa pengamatan ini mungkin dapat dijelaskan oleh terjadinya perkumpulan yang melibatkan banyak orang, meskipun kami akan membutuhkan data epidemiologis tambahan untuk menyelidikinya lebih lanjut.
<!-- There is no right-side text -->
...
#### SARS-COV-2 telah terintroduksi ke Rusia berkali-kali; perebakan di Moskwa sangatlah heterogen.
<br><br>
#### Ada beberapa kali introduksi ke Sankt-Peterburg. Salah satu introduksi ini, dari Eropa Barat pada awal Maret, menyebabkan klaster besar kasus yang ditularkan secara lokal.
<br><br>
#### Sesudah introduksi berulang yang terkait perjalanan, telah terjadi percampuran garis keturunan virus yang meluas dan cepat di seluruh Turki.
<br><br>
#### Ada setidaknya 5 rantai penularan lokal yang beredar di Republik Ceko.  
<br><br>
#### Ada setidaknya 11 kali introduksi virus ini ke Polandia.  
<br><br>
#### Kami telah menerima sampel awal dari Hongaria, Latvia, Slowakia, dan Slovenia. Meskipun kami belum memiliki cukup data untuk menarik kesimpulan, kami akan terus memantau dan memberikan pembaruan sesegera mungkin.
```
...
<br><br>
Daftar sekuens spesifik yang disediakan oleh masing-masing laboratorium [tercantum di sini](https://github.com/nextstrain/ncov/blob/e8020ca13e420bb62e31acf9a07268bc08b11c63/narratives/sit-rep_credits.md).
<br><br>
