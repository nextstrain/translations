...
* [Bacaan latar belakang](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-17?n=2).     
* [Perihal data ini](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-17?n=3).
* [Pembaruan untuk New York](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-17?n=4).
* [Pembaruan untuk California](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-17?n=7).
* [Pembaruan untuk Midwest](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-17?n=8).
* [Pembaruan untuk Rocky Mountain West](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-17?n=9).
* [Apa yang Anda dapat lakukan](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-17?n=10).
* [Pengakuan ilmiah](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-17?n=11).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Ringkasan

Kami menganalisis 1.347 genom SARS-CoV-2 dari AS yang tersedia untuk publik. Dengan memperbandingkan genomnya, kami dapat mengkarakterisasi bagaimana SARS-CoV-2 bergerak di seluruh dunia dan menyebar secara lokal. Pada pembaruan pekan ini, kami melaporkan:  

* Perebakan di New York memiliki asal kosmopolitan, namun mayoritas kasusnya disebabkan oleh introduksi dari Eropa.   
* Perebakan di Kota New York menunjukkan percampuran kasus di kelima _borough_.  
* Perebakan di California berkaitan dengan negara bagian Washington yang dekat maupun New York yang lebih jauh.  
* Perebakan di Midwest bersifat heterogen dan disebabkan oleh banyak introduksi terpisah.
* Perebakan yang sedang terjadi di Utah dan Idaho sangat terkait erat.
* Keputusan yang dibuat oleh masing-masing negara bagian sangat berpengaruh bagi negara bagian lainnya. Agar pengurangan pembatasan di suatu negara bagian berjalan dengan aman, diperlukan usaha pengendalian yang terkoordinasi, dan semua negara bagian harus berperan untuk saling melindungi.
...
# [Informasi mengenai COVID-19](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree&f_country=USA&p=full&r=division)
...
Saat ini kami memiliki sekuens dari sampel yang dikumpulkan dari 36 negara bagian. Ini adalah prestasi yang luar biasa -- melakukan sekuensing virus RNA besar dan belum dikenal di tengah-tengah pandemi merupakan hal yang sulit, dan hanya mungkin dilakukan melalui kerja luar biasa dan pembagian data yang tepat waktu oleh para ilmuwan dan dokter di seluruh dunia.
<br><br>
...
# [Saling keterkaitan kasus dari kelima _borough_ Kota New York](https://nextstrain.org/ncov/north-america/2020-04-17?c=location&d=tree,map&f_division=New%20York&f_location=Bronx,Brooklyn,Queens,Staten%20Island,Manhattan&label=clade:A2&p=full&r=location)

Di Kota New York, kami melihat sedikit segregasi kasus berdasarkan _borough_. Ini menunjukkan banyaknya percampuran kasus di seluruh kota tersebut.
<!-- This is no right-side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 7-->
# [Perebakan di California berhubungan dengan negara bagian lain yang dekat maupun jauh](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&f_division=California,New%20York,Washington&r=division&d=tree,map&legend=closed)

Kami juga melihat bukti introduksi berulang antarnegara bagian. Sebagai contoh, kasus-kasus dari California menjangkau keragaman genetik pohon filogenetik ini, berkelompok bersama sampel-sampel dari negara bagian Washington dan New York. Ini menjadi bukti penularan antara California dengan negara bagian lain yang dekat maupun jauh.
...
# [Bibit perebakan di Midwest berasal dari introduksi multipel](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_country=USA&f_division=Illinois,Indiana,Iowa,Kansas,Michigan,Minnesota,Nebraska,Ohio,Wisconsin&p=full&r=division)

Menyorot sekuens dari Midwest, kami melihat kasus-kasus dari wilayah ini menyebar merata di pohon filogenetik, tidak membentuk rangkaian klaster yang ketat. Ini menunjukkan bahwa terdapat banyak introduksi mandiri ke negara-negara bagian ini, dengan beberapa rantai penularan yang beredar secara bersamaan.
...
# [Perebakan yang saling terkait di Rocky Mountain West](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_country=USA&f_division=Idaho,Utah&label=clade:A2&m=div&p=full&r=division)

Introduksi multipel terjadi juga ke Rocky Mountain West. Jika ditinjau lebih dekat, terdapat rantai penularan yang tampak jelas melintasi Idaho. Khususnya, rangkaian kasus ini diapit oleh satu klaster kasus dari Utah, menunjukkan adanya hubungan yang erat di antara kedua perebakan ini.
...
* Introduksi dari Eropa menyebabkan mayoritas perebakan di New York, namun terdapat juga introduksi dari daerah-daerah lain.
<br><br>
* Seiring dengan berkembangnya wabah, kami juga melihat adanya reintroduksi dari AS ke Eropa dan Asia.
<br><br>
* Perebakan di Kota New York menunjukkan percampuran kasus di kelima _borough_.
<br><br>
* Perebakan di California terkait dengan negara bagian Washington yang dekat dan New York yang lebih jauh.
<br><br>
* Perebakan di Midwest bersifat heterogen, dihasilkan oleh beberapa rantai penularan yang beredar di wilayah ini.
<br><br>
* Perebakan di Utah dan Idaho berkaitan erat, dengan penularan komunitas yang sedang berlangsung.
<br><br>
* Keputusan yang dibuat oleh setiap negara bagian berpengaruh besar terhadap nasib wilayah lain. Agar pengurangan pembatasan di suatu negara bagian berjalan dengan aman, diperlukan usaha pengendalian yang terkoordinasi, dan semua negara bagian harus berperan untuk saling melindungi.  
```
...
# [Pengakuan ilmiah](https://nextstrain.org/ncov/north-america/2020-04-17?d=map&c=author)
