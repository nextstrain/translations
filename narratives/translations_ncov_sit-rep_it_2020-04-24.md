---
title: Analisi genomica della diffusione del COVID-19. Rapporto sulla situazione aggiornato al 24 aprile 2020. 
authors:
  - Cassia Wagner
  - Sidney M. Bell
  - Emma Hodcroft
...
abstract: "Questo rapporto usa sequenze genomiche virali pubblicamente condivise per tracciare la diffusione del COVID-19. Questa settimana, il rapporto è focalizzato sull'Africa. Abbiamo osservato molte introduzioni separate del virus in Repubblica Democratica del Congo (RDC), Senegal, Ghana, Nigeria, Gambia, Algeria e Sudafrica. Abbiamo trovato prove di trasmissioni locali a Kinshasa, RDC; a Dakar e Touba, Senegal; nella regione della Grande Accra, Ghana."
---
...
# [Sommario](https://nextstrain.org/ncov/africa/2020-04-24?d=map,tree&f_region=Africa)

<!-- * [Background resources](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-24?n=2). -->
* [Risorse di base](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-24?n=2). 
<!-- * [About this data](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-24?n=3).-->
* [Una nota sulla raccolta dei campioni](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-24?n=3).
<!-- * [The genetic diversity of SARS-CoV-2 in Africa](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-24?n=4).-->
* [La diversità genetica del SARS-CoV-2 in Africa](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-24?n=4).
<!--  * [Updates for the DRC](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-24?n=5).-->
* [Aggiornamenti sulla Repubblica Democratica del Congo (RDC)](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-24?n=5).
<!--  * [Updates for Senegal](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-24?n=7).-->
* [Aggiornamenti sul Senegal](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-24?n=7).
<!--  * [Updates for Ghana](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-24?n=8).-->
* [Aggiornamenti sul Ghana](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-24?n=8).
<!-- * [Updates for Algeria, Gambia, Nigeria, and South Africa](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-24?n=10).-->
* [Aggiornamenti su Algeria, Gambia, Nigeria e Sudafrica](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-24?n=10).
<!-- * [What you can do](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-24?n=11).-->
* [Cosa puoi fare](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-24?n=11).
<!-- * [Scientific credit](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-24?n=12).-->
* [Riconoscimenti scientifici](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-24?n=12).
...
Abbiamo analizzato 1338 genomi condivisi pubblicamente del virus SARS-Cov-2. Confrontando questi genomi virali tra loro, possiamo tracciare come il virus SARS-CoV-2 si sta spostando nel mondo e si sta diffondendo all'interno delle comunità. Questa settimana il rapporto è focalizzato sull'Africa e riportiamo:
<br><br>
...
* Ci sono state molte introduzioni separate del virus SARS-CoV-2 nel continente africano, principalmente dall'Europa (sebbene è probabile che non tutti i casi siano stati sequenziati, e ciò potrebbe aver alterato l'interpretazione statistica)
<!-- (sebbene ci possa un bias nella raccolta dei campioni che potrebbe alterare la nostra interpretazione dei dati) -->
<br><br>
<!--  * At least 7 introductions to the DRC -->
* Ci sono state almeno 7 diverse introduzioni del virus nella RDC  
<br><br>
<!-- * 2 separate transmission chains circulating in Kinshasa, DRC  -->
* Ci sono 2 diverse catene di trasmissione che circolano a  Kinshasa, RDC
<br><br>
<!-- * Of 8 introductions to Senegal, at least 2 seeded local transmission chains in Dakar and Touba -->
* Delle 8 introduzioni del virus in Senegal, almeno 2 sono iniziate da catene di trasmissione locali a Dakar e Touba
<br><br>
<!-- * Local transmission in Greater Accra, Ghana, after 7 introductions to this region -->
* C'è trasmissione locale nella regione della Grande Accra, Ghana, dopo 7 introduzioni del virus in questa regione
<br><br>
<!--  * Scattered introductions to Algeria, Gambia, Nigeria, and South Africa -->
* Ci sono introduzioni sparse in Algeria, Gambia, Nigeria e Sudafrica
```
...
# [Risorse sul COVID-19](https://nextstrain.org/ncov/africa/2020-04-24?d=tree&p=full&legend=closed&f_region=Africa)
...
* [Chiedi ad uno scienziato e domande frequenti](https://covid19.fas.org/).
...
# [Una nota sulla raccolta dei campioni](https://nextstrain.org/ncov/africa/2020-04-24?d=map&f_region=Africa&p=full)
...
Al momento abbiamo sequenze raccorte in 6 continenti. In Africa, abbiamo sequenze provenienti da 7 Stati. 
Questa è un'impresa incredibile, sequenziare un virus con un RNA così grande e sconosciuto nel bel mezzo di una pandemia è difficile ed è stato possibile solamente grazie all'incredibile sforzo e la tempestiva condivisione dei dati da parte di scienziati e medici in tutto il mondo.
<br><br>
...
Ad esempio, la cartina mostra poche sequenze dall'Africa orientale. Questo non perché il COVID-19 non stia circolando in queste aree, o perché questi casi non siano importanti per capire la diffusione del virus; semplicemente non abbiamo molti dati disponibili per queste aree. La dimensione di ogni cerchio sulla mappa indica quanti dati sono attualmente disponibili per quell'area, piuttosto che la vera dimensione dell'epidemia.
...
# [Molte introduzioni separate hanno dato origine a diverse catene di trasmissione locale in Africa](https://nextstrain.org/ncov/africa/2020-04-24?d=tree,map&f_region=Africa&p=full&r=country&legend=open)
<!--  At the time of writing, the [Africa CDC](https://africacdc.org/covid-19/) reports 26,144 confirmed COVID-19 cases and 1,247 deaths across the African Union.
  ...
  Mentre scriviamo, il Center for Disease Control and Prevention africano [Africa CDC](https://africacdc.org/covid-19/) riporta 26.144 casi confermati di COVID-19 e 1247 vittime in tutta l'Unione Africana.
  Abbiamo genomi virali da 83 di questi casi, provenienti da 7 nazioni africane, mostrate qui (a colori) su uno sfondo di sequenze contestuali da altri luoghi nel mondo (in grigio). Lodiamo i dipartimenti di salute pubblica locali per la rapida risposta e la condivisione pubblica dei dati.
  <br><br>
<!--  These samples span the full diversity of the tree, indicating that there have been many independent introductions to the African continent.
  ...
  Queste sequenze sono diffuse in tutta l'ampiezza dell'albero, e ciò indica che ci sono state molteplici introduzioni indipendenti nel continente africano.
  Molte di queste introduzioni sembrano giungere dall'Europa, anche se questo potrebbe essere distorto dal fatto che abbiamo molte più sequenze dall'Europa che dalla maggior parte dei posti nel mondo. Non possiamo escludere la possibilità di trasmissioni intermedie localizzate altrove di cui non abbiamo campioni.
  <br><br>
 ...
 Non abbiamo prove che tutte queste introduzioni abbiano causato una trasmissione nella comunità, ma vediamo gruppi chiari in alcuni punti.
...
# [Ci sono almeno 7 introduzioni nella RDC](https://nextstrain.org/ncov/africa/2020-04-24?d=tree,map&f_region=Africa&p=full&r=country&legend=closed&f_country=Democratic%20Republic%20of%20the%20Congo)
...
Ci sono [359 casi confermati di COVID-19 nella RDC con 25 vittime](https://africacdc.org/covid-19/). Su Nextstrain, abbiamo 40 sequenze dalla RDC.
<br><br>
...
Queste sequenze cadono attraverso l'albero, con prove di almeno 7 introduzioni separate. Come mostrato qui, le introduzioni sono un cambio di colore tra una sequenza (foglie dell'albero) e i suoi antenati (i nodi interni o i punti di diramazione che portano ad essi).
<br><br>
...
Qui, possiamo vedere 7 posti in cui i colori sono cambiati da grigio ad arancione, che rappresentano un'introduzione. Da queste 7 introduzioni, abbiamo prove per almeno 2 catene di trasmissione locale.
...
# [Due catene di trasmissione locale a Kinshasa sono iniziate all'inizio di marzo](https://nextstrain.org/ncov/africa/2020-04-24?d=tree&f_country=Democratic%20Republic%20of%20the%20Congo&f_region=Africa&label=clade:A2a&p=full&legend=closed&m=div)
...
In questa vista ingrandita delle ramificazioni dell'albero, possiamo vedere due gruppi che rappresentano la probabile trasmissione locale.
La trasmissione locale assomiglia a un gruppo ristretto di casi provenienti dalla stessa località le cui sequenze sono state raccolte nel tempo, con l'accumulo di diversità genetica (lunghezze dei rami più lunghe, che rappresentano più mutazioni).
<br><br>
<!-- Toward the top of this view, we see a cluster of cases from Kinshasa, all sampled between March 9 and March 22. -->
Verso la cima dell'albero, vediamo un gruppo di casi provenienti da Kinshasa, tutti campioni raccolti tra il 9 e il 22 marzo.
<br><br>
<!-- Toward the middle, we see another cluster of cases from Kinshasa, sampled between March 15 and April 6th. -->
Spostandoci verso la metà dell'albero, vediamo un altro gruppo di casi da Kinshasa, i cui campioni sono stati raccolti tra il 15 marzo e il 6 aprile.
<br><br>
...
Da ciò, possiamo concludere che 2 catene di trasmissione separate stavano circolando a Kinshasa tra l'inizio di marzo e l'inizio di aprile 2020.
<br><br>
...
La RDC ha segnalato i primi casi di COVID-19 [all'OMS](https://apps.who.int/iris/bitstream/handle/10665/331763/SITREP_COVID-19_WHOAFRO_20200415-eng.pdf) il 10 marzo. La prima sequenza virale su Nextstrain è stata raccolta il 9 marzo ed è stata riportata nel nostro [Rapporto sulla situazione del 27 marzo](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-03-27?n=16).
<!-- There is no right-side text -->
...
# [Almeno 8 introduzioni del virus in Senegal, con due catene di trasmissione locale](https://nextstrain.org/ncov/africa/2020-04-24?d=tree,map&f_country=Senegal&f_region=Africa&m=div&p=full)
...
Similmente a quanto abbiamo osservato nella RDC, qui vediamo sequenze dal Senegal che abbracciano la piena diversità genetica dell'albero. La collocazione di questi campioni nell'albero filogenetico indica che ci sono state almeno 8 introduzioni separate in Senegal tra la fine di febbraio e la fine di marzo. Il Senegal ha riferito i suoi primi casi COVID-19 all'OMS il 28 febbraio, lo stesso giorno in cui il primo campione virale è stato raccolto per il sequenziamento.
...
Come abbiamo riportato nel [Rapporto sulla situazione del 3 aprile](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-03?n=5), almeno 2 di queste introduzioni a fine febbraio o inizio marzo hanno portato a gruppi di trasmissione locali in corso, rispettivamente, a Dakar e Touba.
<br><br>
...
Sebbene la sequenza più recente su Nextstrain dal Senegal risalga al 20 marzo, al momento ci sono [215 casi attivi sconosciuti](http://www.sante.gouv.sn/sites/default/files/COMMUNIQUE%2053%20DU%2023%20AVRIL%202020.pdf) di COVID-19 in Senegal.
<!-- There is no right-side text -->
...
# [Almeno 7 introduzioni del virus in Ghana](https://nextstrain.org/ncov/africa/2020-04-24?d=tree,map&f_country=Ghana&f_region=Africa&p=full)
...
Ci sono [1154 casi confermati di COVID-19 in Ghana con 9 decessi dovuti a cause sconosciute](https://africacdc.org/covid-19/). Su Nextstrain, ci sono 14 sequenze dal Ghana sparse nell'albero filogenetico, che rappresentano almeno 7 introduzioni separate.
<br><br>
...
Il primo caso in Ghana è stato riportato all'OMS l'11 marzo, e il primo genoma virale è stato raccolto da Nextstrain il 24 marzo.
...
# [Trasmissione locale nella regione della Grande Accra, Ghana](https://nextstrain.org/ncov/africa/2020-04-24?label=clade:B4&c=division&d=tree,map&f_country=Ghana,Senegal&f_region=Africa&p=full&r=location&legend=closed)
...
Qui, osserviamo un gruppo di casi strettamente correlati dalla regione della Grande Accra in Ghana, con campioni raccolti tra il 25 e il 30 marzo.
L'antenato comune di questi casi risale a metà febbraio o all'inizio di marzo ed è stato molto probabilmente importato dall'Asia.
<br><br>
...
È interessante notare che esiste una sequenza dal Senegal che si raggruppa strettamente con questo insieme di sequenze, suggerendo la possibilità di una trasmissione tra Senegal e Ghana.
...
# [Introduzioni sparse in Algeria, Gambia, Nigeria, e Sudafrica](https://nextstrain.org/ncov/africa/2020-04-24?c=division&d=tree,map&f_country=Algeria,Gambia,Nigeria,South%20Africa&f_region=Africa&p=full&r=division)
...
Qui osserviamo sequenze isolate da Algeria, Gambia, Nigeria e Sudafrica. Queste sequenze sono sparse su tutto l'albero filogenetico e sono molto isolate le une rispetto alle altre. 
<br><br>
...
Ciò è la prova di molte introduzioni separate in molte nazioni africane, provenienti principalmente dall'Europa.
Senza ulteriori dati, non possiamo ancora dire se qualcuna di queste introduzioni - ed eventualmente quali - ha provocato focolai locali. 
[L' OMS riporta](https://apps.who.int/iris/bitstream/handle/10665/331840/SITREP_COVID-19_WHOAFRO_20200422-eng.pdf) focolai che contano più di 3400 casi in Sudafrica, di 2800 in Algeria e di 500 in Nigeria.
...
* Indossare la mascherina (anche quelle fatte in casa vanno bene) in pubblico.
* Ricorda che, anche se non fai parte delle categorie vulnerabi, molte persone lo sono; segui queste regole per proteggere gli altri.
...
#### Ci sono state molte introduzioni indipendenti del virus SARS-CoV-2 nel continente africano, principalmente dall'Europa (sebbene è probabile che non tutti i casi siano stati sequenziati, e ciò potrebbe aver alterato l'interpretazione statistica).
<br><br>
<!--  #### 7 introductions to the DRC have led to at least 2 separate transmission chains circulating in Kinshasa.   -->
#### 7 introduzioni nella RDC hanno dato inizio ad almeno 2 catene di trasmissione separate circolanti a Kinshasa. 
<br><br>
<!-- #### Similarly, 8 introductions to Senegal seeded local transmission chains in Dakar and Touba.    -->
#### Similmente, 8 introduzioni del virus in Senegal hanno dato inizio le catene di trasmissione locale a Dakar e Touba.
<br><br>
<!-- #### SARS-CoV-2 has been introduced to Ghana at least 7 times, with local transmission in Greater Accra.  -->
#### Il virus SARS-CoV-2 è stato introdotto in Ghana almeno 7 volte, con trasmissione locale nella regione della Grande Accra.
<br><br>
...
#### Ci sono state introduzioni sparse in Algeria, Gambia, Nigeria e Africa orientale. Non abbiamo ancora abbastanza sequenze per fare inferenza statistica sulla trasmissione locale utilizzando i dati delle sequenze virali.
```
...
La lista delle specifiche sequenze fornite da ogni laboratorio sono [elencate qui](https://github.com/nextstrain/ncov/blob/52a133354c70d712a99f2d2a62116defe0f605ff/narratives/sit-rep_credits.md).
<br><br>
