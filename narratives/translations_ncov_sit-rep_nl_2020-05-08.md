---
title: Genomische analyse van COVID-19 verspreiding. Situatierapportage 2020-05-08.
authors:
  - Cassia Wagner
  - Sidney M. Bell
  - Nicola Müller
...
abstract: "Deze wekelijkse rapportage maakt gebruik van openbaar gedeelde genomische gegevens om de verspreiding van COVID-19 te volgen. Deze week richten we ons op Azië. We rapporteren vele afzonderlijke, onafhankelijke introducties in India; context voor de uitbraak van gastarbeiders in Singapore; en de prevalentie van internationale verspreiding in de regio."
---
...
* [Oorsprong van de epidemie in India](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-08?n=4).  
* [Contextualisering van de heropleving van gevallen in Singapore](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-08?n=5).  
* [Introducties in Maleisië](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-08?n=6).  
* [Frequente spreiding over internationale grenzen](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-08?n=7).    
* [Wetenschappelijke verdienste](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-08?n=8).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Samenvatting

We analyseerden 2.226 openbaar gedeelde COVID-19-genomen. Door deze virale genomen met elkaar te vergelijken, kunnen we karakteriseren hoe COVID-19 de wereld rond beweegt en zich lokaal verspreidt. In de update van deze week richten we ons op de recente verspreiding in Azië. Wij melden:

* Meerdere introducties in Delhi in maart 2020 van over de hele wereld
* Vele afzonderlijke introducties in Singapore, waarvan de meeste niet verder lijken te zijn verspreid
* Uitbreiding van een groot cluster aan gevallen in Singapore, waarschijnlijk gedreven door sociologische factoren
* Vergelijkbare patronen van internationale verspreiding die de dringende behoefte aan samenwerking onderstrepen
...
# [COVID-19 Bronnen](https://nextstrain.org/ncov/asia/2020-05-08?d=tree&p=full&legend=closed&f_region=Asia)
We hebben enkele bronnen voorbereid, die het interpreteren van de data in dit verhaal makkelijker maken.
#### Nextstrain Bronnen
...
* [NYTimes COVID-19 rapportering (Engels)](https://www.nytimes.com/news-event/coronavirus).
...
# [Een opmerking over bemonstering](https://nextstrain.org/ncov/asia/2020-05-08?c=country&r=country&d=map&p=grid&legend=closed)
We hebben momenteel sequenties van monsters die zijn genomen in 28 landen in Azië. Dit is een ongelooflijke prestatie -- het sequencen van een onbekend, groot RNA-virus tijdens een pandemie is moeilijk en is alleen mogelijk door het ongelooflijke werk en het tijdig delen van gegevens door wetenschappers en artsen over de hele wereld.
<br> <br>
Hoewel deze gegevens ons in staat stellen veel nuttige kenmerken van de uitbraak af te leiden en de verspreiding in realtime te volgen, is het belangrijk te benadrukken dat onze conclusies beperkt worden door de beschikbare gegevens.
<br> <br>
Zo toont de kaart heel weinig monsters uit het Midden-Oosten. Dit komt NIET omdat COVID-19 niet in deze gebieden circuleert, of omdat deze gevallen niet net zo cruciaal zijn om te begrijpen; we hebben gewoon niet veel gegevens uit deze gebieden beschikbaar. De grootte van elke cirkel op de kaart geeft aan hoeveel gegevens er momenteel beschikbaar zijn in dat gebied, in plaats van de ware grootte van de uitbraak.
...
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Veel afzonderlijke introducties in maart in Delhi](https://nextstrain.org/ncov/asia/2020-05-08?c=division&d=tree,map&dmax=2020-04-15&dmin=2020-03-01&f_country=India&f_division=Delhi&p=full&r=country&m=div)

Tussen 1 maart en 15 april werden 38 virale genomen uit de regio Delhi bemonsterd en gesequenced (hier weergegeven).
<br> <br>
In het midden van de boom zien we een omvangrijk cluster van nauw verwante gevallen. Dit komt overeen met een enkele introductie, gevolgd door de verspreiding in de lokale gemeenschap.
<br> <br>
Het is echter cruciaal om de context van dit cluster te beschouwen.
Verspreid over de boom zien we ook vele andere kleine clusters en geïsoleerde gevallen, die afzonderlijke introducties van over de hele wereld vertegenwoordigen.
We hebben niet genoeg gegevens om te zeggen wat er op deze andere introducties volgde -- of en hoe ver deze zich verspreidden. Maar we kunnen wel zeggen dat het grote cluster van gevallen slechts een deel van het verhaal is.
...
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Contextualisering van de heropleving van SARS-CoV-2 in Singapore](https://nextstrain.org/ncov/asia/2020-05-08?d=tree,map&dmin=2020-02-26&f_country=China,Singapore,India,Philippines&p=full&legend=closed&r=division)

In de afgelopen 10 weken is SARS-CoV-2 vele malen vanuit verschillende locaties in Singapore geïntroduceerd.
<br> <br>
De meeste van deze introducties hebben geleid tot beperkte verdere transmissie (losse gevallen of kleine clusters in de boom).
<br> <br>
In het midden van de boom zien we echter een enkele introductie die tot een uitgebreide verdere transmissie heeft geleid.
Dit grote, samenhangende cluster is het meest verwant aan monsters uit India en de Filipijnen.
<br> <br>
Dit komt overeen met [recente rapporten (Engels)](https://www.nytimes.com/interactive/2020/04/28/world/asia/coronavirus-singapore-migrants.html) dat het virus zich snel verspreidt onder kwetsbare, ingeperkte bevolkingsgroepen van gastarbeiders in Singapore.
<br> <br>
Dit illustreert hoe de mate waarin een introductie zich binnen een populatie verspreidt, afhangt van sociologische factoren en benadrukt waarom het van cruciaal belang is om kwetsbare groepen te beschermen.
...
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Herhaalde introducties in Maleisië](https://nextstrain.org/ncov/asia/2020-05-08?f_country=Malaysia&d=tree,map&r=division)

We hebben 14 sequenties uit Maleisië op Nextstrain, bemonsterd tussen eind januari en eind maart. Deze sequenties groeperen zich met verschillende clades, die ieder voornamelijk in andere Aziatische landen circuleerden. Dit suggereert dat er meerdere introducties zijn geweest vanuit de omliggende regio naar Maleisië.



<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Regionale verspreiding door Azië](https://nextstrain.org/ncov/asia/2020-05-08?d=tree,map&f_country=Japan,Jordan,Thailand,United%20Arab%20Emirates)

Een soortgelijk patroon herhaalt zich voor veel andere landen in de regio: meerdere introducties, waarvan er vele goed onder controle gehouden zijn, maar met een paar die losbarstten en lokale transmissie veroorzaakten. We moedigen u aan om "zelf de gegevens te verkennen" ("Explore the Data Yourself"). Zoals u hier kunt zien, zult u vergelijkbare patronen zien in Jordanië, Japan, Thailand en de Verenigde Arabische Emiraten. Soortgelijke patronen zijn ook te zien in Koeweit, Georgië, Taiwan en Vietnam.
<br> <br>
Dit herhaalde patroon is een sterk bewijs dat het virus regelmatig de internationale grenzen overschrijdt. Om de epidemie in een enkel land effectief te bestrijden, moeten we dus de pandemie in alle landen beheersen door middel van gecoördineerde internationale inspanningen.
...
#### De uitbraak in India is het resultaat van vele afzonderlijke introducties van over de hele wereld.
<br> <br>
#### In Singapore versnelden sociologische factoren de uitbreiding van één introductie tot een grote uitbraak, in tegenstelling tot de vele introducties die zich niet wijd hebben verspreid.
<br> <br>
#### In Azië hebben de uitbraken van de meeste landen een vergelijkbare geschiedenis: vele afzonderlijke introducties uit andere landen, waarvan sommige leidden tot lokale verspreiding. Dit patroon van meerdere introducties door de tijd benadrukt de noodzaak van internationale en regionale samenwerking om de pandemie volledig onder controle te krijgen.
...
<br><br>
De specifieke sequenties die door ieder lab zijn verstrekt vind u [hier](https://github.com/nextstrain/ncov/commit/75edf84600fdf9ca6ef086d0aefd2978bc621eca).
<br><br>
