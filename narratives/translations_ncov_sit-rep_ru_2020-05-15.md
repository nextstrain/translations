...
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Мутация D614G может быть связана с передачей, но также может быть объяснена географически](https://nextstrain.org/ncov/global/2020-05-14?c=gt-S_614&gmax=25778&gmin=21082&p=full)

[Недавний препринт](https://www.biorxiv.org/content/10.1101/2020.04.29.069054v1) предполагает, что одиночная мутация, D614G (аминокислота "D", находящаяся на месте 614 в "S" ('spike') белке, была заменена на аминокислоту "G"), могла привести к увеличению передаваемости SARS-CoV-2.
<br><br>
