...
<br><br>
Например, здесь мы показываем вирусное "семейное дерево", в котором каждый образец раскрашен в соответствии с аминокислотой, найденной в определенном локусе вирусного генома (в данном случае: в гене "ORF1a", участок 57).
<br><br>
...
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [D614G может быть связано с передачей, но также может быть объяснено географией](https://nextstrain.org/ncov/global/2020-05-14?c=gt-S_614&gmax=25778&gmin=21082&p=full)

[Недавний препринт](https://www.biorxiv.org/content/10.1101/2020.04.29.069054v1) предполагает, что одиночная мутация, D614G (аминокислота "D", находящаяся на месте 614 в "S" ('spike') белке, была заменена на "G"), могла привести к увеличению передаваемости SARS-CoV-2.
<br><br>
Во многих географических районах относительная частота 614D по сравнению с 614G со временем увеличилась.
Если определенный генотип приводит к лучшей передаче, мы ожидаем, что его частота будет увеличиваться со временем.
...
<br><br>
**Мы призываем вас нажать «Исследовать данные самостоятельно» и прокрутить вниз, чтобы увидеть полный список авторов; вы также можете увидеть автора каждой отдельной последовательности, выбрав ее на дереве.**
<br><br>
