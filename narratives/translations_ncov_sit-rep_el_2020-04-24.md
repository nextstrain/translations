...
# [Πολλές ξεχωριστές εισαγωγές έχουν δημιουργήσει διαφορετικές τοπικές αλυσίδες διασποράς στην Αφρική](https://nextstrain.org/ncov/africa/2020-04-24?d=tree,map&f_region=Africa&p=full&r=country&legend=open)
  Τη στιγμή που συντάσσουμε αυτή την αναφορά, ο [αφρικανικός CDC](https://africacdc.org/covid-19/) αναφέρει 26.144 επιβεβαιωμένα κρούσματα COVID-19 και 1.247 θανάτους σε ολόκληρη την Αφρικανική Ένωση.
  ...
  Πολλές από αυτές τις εισαγωγές φαίνεται να προέρχονται από την Ευρώπη, αν και αυτό μπορεί να οφείλεται στο γεγονός ότι έχουμε περισσότερες αλληλουχίες από την Ευρώπη σε σχέση με τα περισσότερα άλλα μέρη του κόσμου. Δεν μπορούμε να αποκλείσουμε την πιθανότητα ενδιάμεσων μεταδόσεων σε άλλες τοποθεσίες από τις οποίες δεν έχουμε διαθέσιμα δείγματα.
  <br><br>
...
Υπάρχουν [359 επιβεβαιωμένα κρούσματα COVID-19 και 25 θάνατοι στη ΛΔΚ](https://africacdc.org/covid-19/). Στο Nextstrain έχουμε 40 αλληλουχίες από τη ΛΔΚ.
<br><br>
Αυτές οι αλληλουχίες βρίσκονται διάσπαρτες στο δέντρο, με ενδείξεις για τουλάχιστον 7 ξεχωριστές εισαγωγές του ιού. Όπως παρουσιάζονται εδώ, οι εισαγωγές χαρακτηρίζονται με αλλαγή χρώματος μεταξύ ενός δείγματος (άκρες του δέντρου) και των προγόνων του (εσωτερικοί κόμβοι ή σημεία διακλάδωσης που οδηγούν σε αυτό).
<br><br>
Εδώ βλέπουμε 7 σημεία όπου τα χρώματα έχουν αλλάξει από γκρι σε πορτοκαλί, αντιπροσωπεύοντας το καθένα μια εισαγωγή του ιού. Από αυτές τις 7 εισαγωγές, έχουμε ενδείξεις για τουλάχιστον 2 τοπικές αλυσίδες διασποράς που προέκυψαν έπειτα.
...
<br><br>
Από τα παραπάνω συμπεραίνουμε ότι υπήρξαν τουλάχιστον 2 ξεχωριστές τοπικές αλυσίδες διασποράς στην Κινσάσα από τις αρχές Μαρτίου έως και τις αρχές Απριλίου 2020.
<br><br>
...
# [Τουλάχιστον 7 εισαγωγές στην Γκάνα](https://nextstrain.org/ncov/africa/2020-04-24?d=tree,map&f_country=Ghana&f_region=Africa&p=full)

Υπάρχουν [1.154 επιβεβαιωμένα κρούσματα COVID-19 και 9 γνωστοποιημένοι θάνατοι στην Γκάνα](https://africacdc.org/covid-19/). Στο Nextstrain υπάρχουν 14 αλληλουχίες από την Γκάνα διασκορπισμένες σε ολόκληρο το φυλογενετικό δέντρο, αντιπροσωπεύοντας τουλάχιστον 7 ξεχωριστές εισαγωγές.
<br><br>
Το πρώτο κρούσμα από την Γκάνα αναφέρθηκε στον ΠΟΥ στις 11 Μαρτίου και το πρώτο ιικό γονιδίωμα στο Nextstrain συλλέχθηκε στις 24 Μαρτίου.
...
Εδώ βλέπουμε μια ομαδοποίηση κρουσμάτων που σχετίζονται στενά από την ευρύτερη περιοχή της Greater Accra της Γκάνα, από δείγματα που ελήφθησαν μεταξύ 25 και 30 Μαρτίου.
...
<br><br>
Είναι ενδιαφέρον ότι ένα δείγμα από τη Σενεγάλη ομαδοποιείται στενά με αυτό το σύμπλεγμα από την Γκάνα, υποδηλώνοντας τη δυνατότητα διασποράς του ιού μεταξύ Σενεγάλης και Γκάνας.
...
<br><br>
#### Ο SARS-CoV-2 έχει εισαχθεί στην Γκάνα τουλάχιστον 7 φορές και υπάρχει τοπική διασπορά στην περιοχή Greater Accra.
<br><br>
#### Έχουν γίνει διάσπαρτες εισαγωγές του ιού στην Αλγερία, την Γκάμπια, τη Νιγηρία και τη Νότια Αφρική. Δεν έχουμε ακόμη αρκετά δείγματα ώστε να εντοπίσουμε στις περιοχές αυτές γεγονότα τοπικής διασποράς από τα δεδομένα των αλληλουχιών.
```
