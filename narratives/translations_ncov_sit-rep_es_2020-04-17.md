---
title: Análisis genómico de la propagación del COVID-19. Reporte 17-04-2020.
authors:
  - Sidney M. Bell
  - Emma Hodcroft
  - Cassia Wagner
...
abstract: "Este reporte utiliza datos genómicos públicos para el seguimiento de la propagación del COVID-19. Los reportes son actualizados semanalmente. Esta semana nos enfocamos en el brote en los EEUU. Para la mayoría de las áreas de los EEUU, encontramos evidencia de múltiples introducciones, tanto de origen internacional como nacional. Estos datos resaltan que las decisiones tomadas por cada estado afectan profundamente el destino de los demás."
...
# [Contenidos](https://nextstrain.org/ncov/north-america/2020-04-17?d=tree,map&p=grid)

* [Información básica del COVID-19](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-04-17?n=2).     
* [Acerca del muestreo de datos](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-04-17?n=3).
* [Actualizaciones de Nueva York](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-04-17?n=4).
* [Actualizaciones de California](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-04-17?n=7).
* [Actualizaciones del Medio Oeste estadounidense](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-04-17?n=8).
* [Actualizaciones de la Región Oeste de la Montañas Rocosas](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-04-17?n=9).
* [¿Qué puedes hacer tú?](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-04-17?n=10).
* [Créditos Científicos](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-04-17?n=11).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Resumen ejecutivo

Analizamos 1,347 genomas de SARS-CoV-2 compartidos públicamente provenientes de los EEUU. Comparando estos genomas entre sí, podemos caracterizar cómo el SARS-CoV-2 se está desplazando alrededor del mundo y propagando localmente. Actualizaciones de esta semana:  

* El brote de Nueva York tiene orígenes cosmopolitas, pero la mayoría de los casos son atribuibles a introducciones desde Europa.   
* El brote en la ciudad de Nueva York muestra que los casos se mezclan entre todos los 5 distritos.
* El brote en California está relacionado tanto con el brote cercano en el estado de Washington como con el distante en Nueva York.
* El brote en el Medio Oeste del país es heterogéneo y resultado de muchas introducciones independientes.
* Los brotes en curso en los estados de Utah y Idaho están estrechamente relacionados.
* Las decisiones tomadas por parte de cada estado tienen un impacto profundo en el destino de los otros. La reducción segura de las restricciones en cualquier estado requerirá una contención coordinada, con todos los estados actuando para protegerse entre sí.
...
# [Información básica del COVID-19](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree&f_country=USA&p=full&r=division)
Hemos compilado información para facilitar la interpretación de los datos que presentamos en este reporte.
...
* [Preguntas frecuentes](https://covid19.fas.org/l/es).
...
# [Acerca del muestreo de datos](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=map&f_country=USA&p=full&r=division)
Actualmente tenemos secuencias virales de 36 estados. Este es un logro increíble: secuenciar un virus de ARN desconocido y de gran tamaño durante una pandemia es difícil, y solo es posible gracias al increíble trabajo y al intercambio de datos por parte de científicos y médicos de todo el mundo.
<br><br>
...
<br><br>
Por ejemplo, el mapa muestra muy pocas secuencias del centro de los EEUU. Esto NO se debe a que el COVID-19 no esté circulando en estas zonas, o a que la comprensión de estos casos no sea importante; simplemente NO EXISTEN muchos datos de estas zonas. Nótese que el tamaño de cada círculo en el mapa indica la cantidad de datos disponibles actualmente de esa área, y no el tamaño real del brote.
...
# [El clado principal de Nueva York está vinculado al brote europeo](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_division=Europe,New%20York&label=clade:A2&p=full&r=country)

Como puede haber visto [esta semana en las noticas](https://www.nytimes.com/2020/04/08/science/new-york-coronavirus-cases-europe-genomes.html), la mayoría de muestras virales de Nueva York (las que están coloreadas) se agrupan con muestras de Europa (en gris).
<br><br>
El clado de Nueva York está flanqueado por e intercalado con secuencias de Europa, lo que sugiere que la mayoría de los primeros casos fueron el resultado de introducciones de Europa.
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 5-->
# [Muchas introducciones a Nueva York](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree&f_division=Europe,New%20York,Asia&label=clade:A2&p=grid&r=location)

La mayoría del brote de Nueva York fue el resultado de introducciones europeas, pero las secuencias contextuales de otras regiones del mundo nos dejan apreciar introducciones adicionales a la ciudad de Nueva York. Fiel a su naturaleza cosmopolita, hay casos en Nueva York estrechamente relacionados con muestras provenientes de cada otra región del mundo.
<br><br>
Los primeros casos en Nueva York probablemente representan transmisiones introducidas desde el exterior. Más adelante en el brote, apreciamos más mezcla entre las muestras de Nueva York y las de Europa, lo que hace que la dirección de las transmisiones posteriores sea menos clara. Como reportamos [la semana pasada](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-04-10?n=11), también hay evidencia de reintroducciones desde los EEUU hacia Europa y Asia.
...
# [Mezcla de casos entre todos los 5 distritos de la ciudad de Nueva York](https://nextstrain.org/ncov/north-america/2020-04-17?c=location&d=tree,map&f_division=New%20York&f_location=Bronx,Brooklyn,Queens,Staten%20Island,Manhattan&label=clade:A2&p=full&r=location)

Dentro de la ciudad de Nueva York, apreciamos poca segregación de casos por distrito (el Bronx, Brooklyn, Manhattan, Queens y Staten Island). Esto es consistente con la mezcla frecuente de casos a través de la ciudad entera.
<!-- This is no right-side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 7-->
# [El brote en California esta relacionado tanto con estados cercanos como lejanos](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&f_division=California,New%20York,Washington&r=division&d=tree,map&legend=closed)

También podemos ver evidencia de introducciones múltiples entre estados. Por ejemplo, los casos de California abarcan toda la diversidad genética del árbol, agrupándose con muestras del estado de Washington y de Nueva York. Esto es evidencia de transmisión entre California y tanto con estados cercanos como distantes.
...
# [El brote del Medio Oeste ha sido causado por muchas introducciones](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_country=USA&f_division=Illinois,Indiana,Iowa,Kansas,Michigan,Minnesota,Nebraska,Ohio,Wisconsin&p=full&r=division)

Las secuencias resaltadas pertenecen al Medio Oeste de los EEUU. Podemos apreciar que los casos en esta región se distribuyen uniformemente en todo el árbol, y no constituyen un conglomerado en si mismas. Esto nos dice que ha habido muchas introducciones independientes en estos estados, con diferentes cadenas de transmisión circulando simultáneamente.
...
# [Brotes relacionados en la Región Oeste de las Montañas Rocosas](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_country=USA&f_division=Idaho,Utah&label=clade:A2&m=div&p=full&r=division)

También han existido varias introducciones en la Región Oeste de las Montañas Rocosas. Viendo mas de cerca, podemos observar una evidente cadena de transmisión cruzando Idaho. Nótese que este conjunto de casos esta flanqueado por otro conglomerado de casos en Utah, demostrando una relación cercana entre estos brotes.
...
* Quedate en casa tanto como sea posible -- especialmente si está enfermo; esté preparado con suministros extra en caso de que necesite hacer una autocuarentena.
* Si eres un empleador, anima a tus empleados a trabajar desde casa siempre que sea posible.

#### ...como funcionario  
* Hacer que las pruebas sean gratuitas y estén ampliamente disponibles.
* Poner en marcha fuertes medidas de distanciamiento social.
* Financiar y poner en práctica esfuerzos extensos de rastreo de contactos.
* Apoyar financieramente a aquellos afectados por las medidas de distanciamiento social.
...
```auspiceMainDisplayMarkdown
# Resumen
* Las introducciones de Europa sembraron la mayor parte del brote en Nueva York, pero también hubo introducciones de otras partes del mundo.
<br><br>
* A medida que el brote ha progresado, también vemos evidencia de re-introducciones desde los EEUU hacia Europa y Asia.
<br><br>
* El brote en la ciudad de Nueva York muestra una mezcla de casos en todos los 5 municipios.
<br><br>
* El brote en California esta relacionado tanto con el brote cercano en el estado de Washington como con el brote lejano en Nueva York.
<br><br>
* El brote en el Medio Oeste es heterogéneo, con múltiples cadenas de transmisión circulando en la región.
<br><br>
* Los brotes en Utah y en Idaho esta íntimamente relacionados, con actual transmisión comunitaria.
<br><br>
* Las decisiones de un estado impactan profundamente el destino de los otros. Una disminución segura de las restricciones en cualquier estado requiere una contención coordinada, donde todos los estados se protejan los unos a los otros.
```
...
# [Créditos Científicos](https://nextstrain.org/ncov/north-america/2020-04-17?d=map&c=author)

Quisiéramos reconocer la excelente y oportuna labor realizada por todos los científicos que participaron en este brote, y en particular los que trabajan en China. Sólo mediante el rápido intercambio de datos y metadatos genómicos es posible realizar análisis como éste.

<br>

También agradecemos a [GISAID](https://gisaid.org) por proporcionar la plataforma a través de la cual estos datos pueden ser cargados y compartidos.

<!-- Do not need to translate institutions names -->
<!-- This is right-side text -->
```auspiceMainDisplayMarkdown

Agradecemos los datos recolectados por los siguientes laboratorios:
...
Los genomas del SARS-CoV-2 fueron compartidos por científicos de los siguientes laboratorios:
...
* Ramathibodi Hospital
	* Thailand/Bangkok-CONI-0017/2020
	* Thailand/Bangkok-CONI-0019/2020
	* Thailand/Bangkok-CONI-0020/2020
	* Thailand/Bangkok-CONI-0021/2020
	* Thailand/Bangkok-CONI-0022/2020
...
* TGen North
	* USA/AZ-TGEN-TG268002/2020
	* USA/AZ-TGEN-TG268099/2020
	* USA/AZ-TGEN-TG268183/2020
	* USA/AZ-TGEN-TG268188/2020
	* USA/AZ-TGEN-TG268281/2020
	* USA/AZ-TGEN-TG268282/2020
	* USA/AZ-TGEN-TG268289/2020
	* USA/AZ-TGEN-TG268350/2020
	* USA/AZ-TGEN-TG268360/2020
	* USA/AZ-TGEN-TG268417/2020
	* USA/AZ-TGEN-TG268629/2020
	* USA/AZ-TGEN-TG268657/2020
	* USA/AZ-TGEN-TG268770/2020
	* USA/AZ-TGEN-TG269027/2020
	* USA/AZ-TGEN-TG269238/2020
	* USA/AZ-TGEN-TG269290/2020
	* USA/AZ-TGEN-TG269358/2020
	* USA/AZ-TGEN-TG269439/2020
	* USA/AZ-TGEN-TG269440/2020
	* USA/AZ-TGEN-TG269824/2020
	* USA/AZ-TGEN-TG270152/2020
	* USA/AZ-TGEN-TG270200/2020
	* USA/AZ-TGEN-TG271435/2020
	* USA/AZ-TGEN-TG271578/2020
	* USA/AZ-TGEN-TG271591/2020
	* USA/AZ-TGEN-TG272213/2020
	* USA/AZ-TGEN-TG272215/2020
