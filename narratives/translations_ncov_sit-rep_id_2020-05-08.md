---
title: Analisis genomik penyebaran COVID-19. Laporan keadaan per 08-05-2020.
authors:
  - Cassia Wagner
  - Sidney M. Bell
  - Nicola Müller
...
abstract: "Laporan mingguan ini menggunakan data genomik yang dibagikan secara publik untuk melacak wabah COVID-19. Pekan ini, fokus kami di Asia. Kami melaporkan banyak introduksi terpisah dan independen ke India; konteks perebakan wabah di kalangan pekerja migran di Singapura; dan prevalensi penyebaran internasional di seluruh kawasan ini."
---
...
* [Asal-usul wabah ini di India](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-05-08?n=4).  
* [Kontekstualisasi munculnya kembali kasus-kasus di Singapura](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-05-08?n=5).  
* [Introduksi ke Malaysia](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-05-08?n=6).  
* [Seringnya penyebaran melintasi perbatasan antarnegara](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-05-08?n=7).    
* [Pengakuan ilmiah](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-05-08?n=8).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Ringkasan

Kami menganalisis 2.226 genom COVID-19 yang tersedia untuk publik. Dengan memperbandingkan genom virus ini, kami dapat mengkarakterisasi bagaimana COVID-19 bergerak di seluruh dunia dan menyebar secara lokal. Dalam pembaruan pekan ini, kami fokus pada penyebaran terkini di Asia. Kami melaporkan:

* Introduksi berulang ke Delhi selama bulan Maret 2020 dari seluruh dunia
* Banyak introduksi terpisah ke Singapura, yang sebagian besar tampaknya tidak menyebar lebih jauh
* Perluasan sekelompok besar kasus di Singapura yang kemungkinan didorong oleh faktor sosiologis
* Pola penyebaran internasional yang serupa yang menekankan kebutuhan mendesak akan upaya kerja sama
```
...
# [Informasi mengenai COVID-19](https://nextstrain.org/ncov/asia/2020-05-08?d=tree&p=full&legend=closed&f_region=Asia)
...
# [Catatan mengenai sampling](https://nextstrain.org/ncov/asia/2020-05-08?c=country&r=country&d=map&p=grid&legend=closed)
Saat ini kami memiliki sekuens dari sampel yang diambil di 28 negara di Asia. Ini adalah raihan luar biasa -- melakukan sekuensing virus RNA besar dan belum dikenal di tengah-tengah pandemi merupakan hal yang sulit, dan hanya mungkin dilakukan melalui kerja luar biasa dan pembagian data yang tepat waktu oleh para ilmuwan dan dokter di seluruh dunia.
<br><br>
...
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Berbagai introduksi terpisah ke Delhi selama bulan Maret](https://nextstrain.org/ncov/asia/2020-05-08?c=division&d=tree,map&dmax=2020-04-15&dmin=2020-03-01&f_country=India&f_division=Delhi&p=full&r=country&m=div)

Antara 1 Maret-15 April, 38 genom virus dari Delhi berhasil diambil dan didapatkan sekuensnya (ditampilkan di sini).
<br><br>
Di tengah pohon filogenetik ini, kita melihat sebuah klaster cukup besar kasus-kasus yang terkait erat. Ini selaras dengan introduksi tunggal yang diikuti oleh penularan lokal dalam komunitas.
<br><br>
Namun begitu, sangat penting untuk mempertimbangkan konteks klaster ini.  
Kita juga melihat klaster-klaster kecil lainnya dan kasus-kasus terisolasi terpencar di seluruh pohon ini, yang mencerminkan introduksi terpisah dari seluruh dunia.
Kami tidak memiliki data yang memadai untuk mengatakan apa yang mengikuti introduksi lainnya ini -- apakah atau sejauh manakah mereka menyebar. Namun demikian, kami dapat mengatakan bahwa klaster besar kasus di atas hanya sebagian dari cerita utuhnya.
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Kontekstualisasi munculnya kembali SARS-CoV-2 di Singapura](https://nextstrain.org/ncov/asia/2020-05-08?d=tree,map&dmin=2020-02-26&f_country=China,Singapore,India,Philippines&p=full&legend=closed&r=division)

Dalam sepuluh pekan terakhir, SARS-CoV-2 telah terintroduksi ke Singapura beberapa kali, dari berbagai daerah.
<br><br>
Kebanyakan introduksi ini mengakibatkan penularan terbatas (kasus tunggal atau klaster kecil pada pohon).
<br><br>
Akan tetapi, di tengah pohon ini kita melihat adanya introduksi tunggal yang mengakibatkan penularan besar.
Klaster besar dan kohesif ini terkait paling dekat dengan sampel dari India dan Filipina.
<br><br>
Ini selaras dengan [laporan baru-baru ini](https://www.nytimes.com/interactive/2020/04/28/world/asia/coronavirus-singapore-migrants.html) bahwa virus ini menular dengan cepat di populasi pekerja migran di Singapura yang lemah dan terbatasi.
<br><br>
Ini menggambarkan sejauh mana penyebaran sebuah introduksi dalam suatu populasi bergantung pada faktor sosiologis dan menekankan sangat pentingnya melindungi golongan masyarakat yang lemah.
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Banyaknya introduksi ke Malaysia](https://nextstrain.org/ncov/asia/2020-05-08?f_country=Malaysia&d=tree,map&r=division)

Kami memiliki 14 sekuens dari Malaysia di Nextstrain, disampel antara akhir Januari dan akhir Maret. Sekuens-sekuens ini menyebar di dalam beberapa klaster berbeda, yang masing-masing bersirkulasi kebanyakan di negara-negara Asia lainnya. Ini mengesankan banyaknya introduksi dari wilayah sekitar ke Malaysia.


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Penularan regional lintas Asia](https://nextstrain.org/ncov/asia/2020-05-08?d=tree,map&f_country=Japan,Jordan,Thailand,United%20Arab%20Emirates)

Pola serupa berulang pada banyak negara lain di wilayah Asia: banyak introduksi, kebanyakan berhasil ditangani, namun ada beberapa yang mencetus penularan lokal. Kami sarankan Anda untuk mengeksplorasi datanya sendiri ("Explore the Data Yourself"). Sebagaimana ditampilkan di sini, Anda akan mengamati pola serupa di Yordania, Jepang, Thailand, dan Uni Emirat Arab. Pola serupa dapat juga ditemui di Kuwait, Georgia, Taiwan, dan Vietnam.
<br><br>
Konsistensi pola ini merupakan petunjuk kuat seringnya virus ini melintasi batas antarnegara. Oleh karena itu, untuk dapat secara efektif mengendalikan epidemi di suatu negara, kita harus mengendalikan pandemi di semua negara melalui upaya internasional yang terkoordinasi.
<!-- There is no right side text -->
...
#### Perebakan wabah ini di India merupakan akibat dari banyak introduksi terpisah dari seluruh dunia.  
<br><br>
#### Di Singapura, faktor-faktor sosiologis mempercepat ekspansi sebuah introduksi menjadi perebakan besar, sementara ada banyak introduksi lain yang tidak menyebar luas.
<br><br>
#### Di Asia, perebakan wabah di sebagian besar negara memiliki sejarah yang serupa: banyak perkenalan terpisah dari negara lain, beberapa di antaranya mengakibatkan penyebaran lokal. Pola introduksi berulang dari waktu ke waktu ini menekankan perlunya kerja sama internasional dan regional untuk sepenuhnya mengendalikan pandemi ini.
```
...
<br><br>
Daftar sekuens spesifik yang disediakan oleh masing-masing laboratorium [tercantum di sini](https://github.com/nextstrain/ncov/commit/75edf84600fdf9ca6ef086d0aefd2978bc621eca).
<br><br>
