---
title: Analisis genomik penyebaran COVID-19. Laporan keadaan per 24-04-2020.
authors:
  - Cassia Wagner
  - Sidney M. Bell
  - Emma Hodcroft
...
abstract: "Laporan mingguan ini menggunakan data genom terbuka untuk melacak penyebaran COVID-19. Pekan ini, fokus kami di Afrika. Kami melaporkan banyak introduksi terpisah ke Republik Demokratik Kongo, Senegal, Ghana, Nigeria, Gambia, Aljazair, dan Afrika Selatan. Kami menemukan bukti transmisi lokal di Kinshasa, Kongo; Dakar dan Touba, Senegal; dan Greater Accra, Ghana."
---
...
# [Daftar isi](https://nextstrain.org/ncov/africa/2020-04-24?d=map,tree&f_region=Africa)

* [Bacaan latar belakang](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-24?n=2).     
* [Perihal data ini](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-24?n=3).
* [Keragaman genetik SARS-CoV-2 di Afrika](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-24?n=4).
* [Pembaruan untuk Republik Demokratik Kongo](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-24?n=5).
* [Pembaruan untuk Senegal](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-24?n=7).
* [Pembaruan untuk Ghana](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-24?n=8).
* [Pembaruan untuk Aljazair, Gambia, Nigeria, dan Afrika Selatan](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-24?n=10).
* [Apa yang Anda dapat lakukan](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-24?n=11).
* [Pengakuan ilmiah](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-24?n=12).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Ringkasan

Kami menganalisis 1.338 genom COVID-19 yang tersedia untuk publik. Dengan memperbandingkan genom virus ini, kami dapat mengkarakterisasi bagaimana SARS-CoV-2 bergerak di seluruh dunia dan menyebar secara lokal. Pekan ini, kami memusatkan perhatian pada Afrika dan melaporkan:
<br><br>
* Banyak introduksi terpisah SARS-CoV-2 ke benua Afrika, terutama dari Eropa (meskipun bias pengambilan sampel dapat berkontribusi pada kesimpulan ini)
<br><br>
* Setidaknya tujuh kali introduksi ke Republik Demokratik Kongo
<br><br>
* Dua rantai penularan terpisah yang beredar di Kinshasa, Kongo
<br><br>
* Dari delapan kali introduksi ke Senegal, setidaknya dua menyebabkan rantai penularan lokal di Dakar dan Touba
<br><br>
* Penularan lokal di Greater Accra, Ghana, setelah tujuh kali introduksi ke wilayah ini
<br><br>
* Introduksi yang tersebar ke Aljazair, Gambia, Nigeria, dan Afrika Selatan
```
...
# [Informasi mengenai COVID-19](https://nextstrain.org/ncov/africa/2020-04-24?d=tree&p=full&legend=closed&f_region=Africa)
Kami telah menyiapkan sejumlah informasi yang akan mempermudah penafsiran data yang kami sajikan pada uraian ini.
...
* [Ask a Scientist ("tanyakanlah kepada ilmuwan")](https://covid19.fas.org/).
...
* [Liputan COVID-19 oleh _The New York Times_](https://www.nytimes.com/news-event/coronavirus).
...
# [Catatan mengenai sampling](https://nextstrain.org/ncov/africa/2020-04-24?d=map&f_region=Africa&p=full)
Saat ini kami memiliki sekuens dari sampel yang diambil di 6 benua. Di Afrika, kami memiliki sampel dari 7 negara. Ini adalah raihan luar biasa -- melakukan sekuensing virus RNA besar dan belum dikenal di tengah-tengah pandemi merupakan hal yang sulit, dan hanya mungkin dilakukan melalui kerja luar biasa dan pembagian data yang tepat waktu oleh para ilmuwan dan dokter di seluruh dunia.
<br><br>
Meskipun data ini memungkinkan kami untuk menyimpulkan karakteristik berguna dari wabah ini dan melacak penyebarannya secara langsung, kami harus menekankan bahwa kesimpulan kami dibatasi oleh data yang tersedia.
<br><br>
Sebagai contoh, peta di samping menunjukkan hanya ada sangat sedikit sekuens dari Afrika Timur. Ini BUKAN karena COVID-19 tidak beredar di daerah ini atau bahwa kasus-kasus ini tidak begitu penting untuk dipahami, melainkan hanya karena kami tidak memiliki banyak data yang tersedia dari wilayah ini. Ukuran setiap lingkaran pada peta menunjukkan berapa banyak data yang saat ini tersedia dari wilayah itu, bukan ukuran wabah sebenarnya.
...
# [Banyak introduksi terpisah menyebabkan banyak rantai penularan lokal di Afrika](https://nextstrain.org/ncov/africa/2020-04-24?d=tree,map&f_region=Africa&p=full&r=country&legend=open)
  Saat uraian ini ditulis, [Pusat Pengendalian dan Pencegahan Penyakit Afrika (Africa CDC)](https://africacdc.org/covid-19/) melaporkan 26.144 kasus COVID-19 terkonfirmasi dan 1.247 kematian di seluruh Uni Afrika.
  Kami memiliki genom virus dari 83 kasus ini dari 7 negara Afrika, ditampilkan di sini (berwarna) dengan latar belakang sekuens kontekstual dari seluruh dunia (berwarna abu-abu). Kami memuji departemen kesehatan masyarakat setempat atas tanggapannya yang cepat dan pembagian data yang terbuka.
  <br><br>
  Sampel-sampel ini menjangkau keragaman penuh pohon, yang menunjukkan bahwa ada banyak introduksi independen ke benua Afrika. Banyak introduksi ini tampaknya berasal dari Eropa, walaupun ini mungkin bias karena kita memiliki lebih banyak sekuens dari Eropa daripada dari sebagian besar tempat lain di dunia. Kami tidak dapat mengesampingkan kemungkinan penularan perantara di tempat lain yang tidak diambil sampelnya.
  <br><br>
  Kami tidak melihat bukti bahwa semua introduksi ini telah mengakibatkan penularan komunitas, tetapi kami melihat sejumlah klaster yang jelas di beberapa lokasi.
...
# [Setidaknya tujuh kali introduksi ke Republik Demokratik Kongo](https://nextstrain.org/ncov/africa/2020-04-24?d=tree,map&f_region=Africa&p=full&r=country&legend=closed&f_country=Democratic%20Republic%20of%20the%20Congo)

Terdapat [359 kasus COVID-19 terkonfirmasi di Republik Demokratik Kongo dengan 25 kematian](https://africacdc.org/covid-19/). Nextstrain memiliki 40 sekuens dari Kongo.
<br><br>
Sekuens-sekuens ini terdapat di seluruh pohon filogenetik, dengan bukti atas setidaknya 7 introduksi terpisah. Seperti ditunjukkan di sini, introduksi terlihat sebagai perubahan warna antara sampel virus (ujung pohon) dan leluhurnya (simpul internal atau titik cabang yang mengarah ke sana).
<br><br>
Di sini, kita dapat melihat 7 tempat dengan warna yang berubah dari abu-abu menjadi jingga, menunjukkan terjadinya introduksi. Dari ketujuh introduksi ini, kami melihat bukti untuk setidaknya 2 rantai penularan lokal.

<!-- There is no right side text -->

<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 6-->
# [Dua rantai penularan lokal di Kinshasa, dimulai pada awal Maret](https://nextstrain.org/ncov/africa/2020-04-24?d=tree&f_country=Democratic%20Republic%20of%20the%20Congo&f_region=Africa&label=clade:A2a&p=full&legend=closed&m=div)

Dalam tampilan divergensi yang diperbesar ini, kita dapat melihat dua klaster yang mewakili kemungkinan penularan lokal.
Penularan lokal tampak seperti klaster kasus yang mengelompok ketat dari lokasi yang sama, disampel dari waktu ke waktu, dengan akumulasi keragaman genetik (cabang lebih panjang, menunjukkan mutasi yang lebih banyak).
<br><br>
Pada bagian atas tampilan ini, kita melihat sekelompok kasus dari Kinshasa, semuanya diambil sampelnya antara 9 Maret dan 22 Maret.
<br><br>
Di tengah, kita melihat sekelompok kasus lain dari Kinshasa, yang diambil sampelnya antara 15 Maret dan 6 April.
<br><br>
Dari sini, kita dapat menyimpulkan bahwa setidaknya 2 rantai penularan terpisah beredar di Kinshasa antara awal Maret dan awal April 2020.
<br><br>
Republik Demokratik Kongo melaporkan kasus-kasus COVID-19 pertamanya [kepada WHO](https://apps.who.int/iris/bitstream/handle/10665/331763/SITREP_COVID-19_WHOAFRO_20200415-eng.pdf) pada 10 Maret. Sampel pertamanya di Nextstrain diambil pada 9 Maret, dan dilaporkan pada [Laporan Keadaan tanggal 27 Maret](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-27?n=16).
<!-- There is no right-side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 7-->
# [Setidaknya delapan kali introduksi ke Senegal, dengan dua rantai penularan lokal](https://nextstrain.org/ncov/africa/2020-04-24?d=tree,map&f_country=Senegal&f_region=Africa&m=div&p=full)

Serupa dengan pola yang ditemukan di Kongo, di sini kita melihat sampel dari Senegal mencakup keragaman genetik penuh pohon. Penempatan filogenetik dari sampel-sampel ini menunjukkan bahwa ada setidaknya 8 introduksi terpisah ke Senegal antara akhir Februari dan akhir Maret. Senegal melaporkan COVID-19 kasus pertamanya ke WHO pada 28 Februari, pada hari yang sama sampel virus pertamanya dikumpulkan untuk disekuensing.
<br><br>
Sebagaimana kami laporkan pada [Laporan Keadaan tanggal 3 April](https://nextstrain.org/narratives/ncov/sit-rep/id/2020-04-03?n=5), setidaknya 2 dari introduksi pada akhir Februari atau awal Maret ini telah menyebabkan rangkaian penularan lokal yang sedang berlangsung di Dakar dan Tabou.
<br><br>
Meskipun sekuens terbaru dari Senegal di Nextstrain diambil pada 20 Maret, saat ini [ada 215 kasus aktif](http://www.sante.gouv.sn/sites/default/files/COMMUNIQUE%2053%20DU%2023%20AVRIL%202020.pdf) COVID-19 yang diketahui di Senegal.
...
# [Setidaknya tujuh kali introduksi ke Ghana](https://nextstrain.org/ncov/africa/2020-04-24?d=tree,map&f_country=Ghana&f_region=Africa&p=full)

Terdapat [1.154 kasus COVID-19 terkonfirmasi di Ghana dengan 9 kematian yang diketahui](https://africacdc.org/covid-19/). Di Nextstrain, ada 14 sekuens dari Ghana yang tersebar di pohon filogenetik, mewakili setidaknya 7 introduksi terpisah.
<br><br>
Kasus pertama di Ghana dilaporkan ke WHO pada 11 Maret, dan genom virus pertamanya pada Nextstrain diambil pada 24 Maret.

<!-- There is no right-side text --><!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 9-->
# [Penularan lokal di Greater Accra, Ghana](https://nextstrain.org/ncov/africa/2020-04-24?label=clade:B4&c=division&d=tree,map&f_country=Ghana,Senegal&f_region=Africa&p=full&r=location&legend=closed)

Di sini, kita melihat klaster kasus terkait erat dari wilayah Greater Accra di Ghana, disampel antara 25 Maret dan 30 Maret.
Leluhur bersama dari kasus-kasus ini berasal dari pertengahan Februari atau awal Maret, dan kemungkinan besar diimpor dari Asia.
<br><br>
Menariknya, ada sampel dari Senegal yang mengelompok ketat dengan klaster ini, menunjukkan kemungkinan penularan antara Senegal dan Ghana.
...
# [Introduksi tersebar ke Aljazair, Gambia, Nigeria, dan Afrika Selatan](https://nextstrain.org/ncov/africa/2020-04-24?c=division&d=tree,map&f_country=Algeria,Gambia,Nigeria,South%20Africa&f_region=Africa&p=full&r=division)

Di sini, kita melihat sampel-sampel yang diisolasi dari Aljazair, Gambia, Nigeria, dan Afrika Selatan. Sampel-sampel ini tersebar di seluruh pohon dan sebagian besar terisolasi satu dengan lainnya.
<br><br>
Ini adalah bukti terjadinya banyak introduksi terpisah, sebagian besar dari Eropa, ke banyak negara di Afrika. Tanpa lebih banyak data, kami belum bisa mengatakan introduksi yang mana yang mengakibatkan wabah lokal -- jika ada. [WHO melaporkan](https://apps.who.int/iris/bitstream/handle/10665/331840/SITREP_COVID-19_WHOAFRO_20200422-eng.pdf) perebakan dengan lebih dari 3400, 2800, dan 500 kasus di Afrika Selatan, Aljazair, dan Nigeria.
...
* Kenakanlah masker (buatan sendiri juga baik) ketika berada di tempat umum.
...
* Danailah dan terapkanlah usaha pelacakan kontak dan isolasi secara luas.  
...
#### Ada banyak introduksi terpisah SARS-CoV-2 ke benua Afrika, terutama dari Eropa (meskipun bias pengambilan sampel dapat berkontribusi pada kesimpulan ini).
<br><br>
#### 7 kali introduksi ke Republik Demokratik Kongo telah menyebabkan setidaknya 2 rantai penularan terpisah yang beredar di Kinshasa.
<br><br>
#### Demikian pula, 8 kali introduksi ke Senegal menyebabkan rantai penularan lokal di Dakar dan Touba.
<br><br>
#### SARS-CoV-2 telah diintroduksi ke Ghana setidaknya 7 kali, dengan transmisi lokal di Greater Accra.
<br><br>
#### Ada banyak introduksi tersebar di Aljazair, Gambia, Nigeria, dan Afrika Selatan. Kami belum memiliki cukup sampel untuk menyimpulkan terjadinya penularan lokal dari data sekuens.
```
...
<br><br>
Daftar sekuens spesifik yang disediakan oleh masing-masing laboratorium [tercantum di sini](https://github.com/nextstrain/ncov/blob/52a133354c70d712a99f2d2a62116defe0f605ff/narratives/sit-rep_credits.md).
<br><br>
