---
title: Análisis Genómico de la propagación del COVID-19. Reporte de Situación al 01-05-2020.
authors:
  - Sidney Bell  
  - Nicola Müller
  - Cassia Wagner
...
affiliations: "Fred Hutch, Seattle, EEUU; Biozentrum, Basel, Suiza; CZI, CA, EEUU"
translators:
  - Claudio S. Fuente
  - Miguel I. Paredes
translatorLinks:
...
date: 01-Mayo-2020
abstract: "Este reporte utiliza datos genómicos públicos para el seguimiento de la propagación del COVID-19. Los reportes son actualizados semanalmente. Esta semana nos enfocamos en la dinámica de brotes a lo largo de Europa Central y del Este."
---
...
# [Contenidos](https://nextstrain.org/ncov/europe/2020-05-01?d=map&f_region=Europe&legend=closed)

* [Recursos Secundarios](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-05-01?n=2).     
* [Sobre esta información](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-05-01?n=3).
* [Actualizaciones de Rusia](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-05-01?n=4).
* [Actualizaciones de la República Checa](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-05-01?n=7).
* [Actualizaciones de Turquía](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-05-01?n=8).
* [Actualizaciones de Polonia](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-05-01?n=9).
* [Actualizaciones de Hungría, Eslovaquia, Eslovenia y Lituania](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-05-01?n=10).
* [¿Qué puedes hacer tú?](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-05-01?n=11).
* [Créditos científicos](https://nextstrain.org/narratives/ncov/sit-rep/es/2020-05-01?n=12).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Resumen Ejecutivo

Analizamos 4.442 genomas compartidos públicamente. Al comparar estos genomas virales, podemos caracterizas como se está moviendo el COVID-19 alrededor del mundo y como se esparce localmente. En estas actualizaciones semanales, nos enfocamos en Europa Central y del Este y reportamos lo siguiente:

* Muchas introducciones en Rusia
* Brotes heterogéneos en Moscú
* La mayor parte del Brote de San Petersburgo esta relacionado con una sola introducción, posiblemente de Europa Occidental
* Una Mezcla extensiva de casos a lo largo de Turquía siguiendo ya repetidas introducciones relacionadas con viajes.
* Al menos 5 cadenas de transmisiones en la República Checa, muy probablemente debidas a repetidas introducciones desde Europa Occidental
* Al menos 11 introducciones separadas en Polonia
* Muestras tempranas desde Hungría, Lituania, Eslovaquia y Eslovenia
```
...
# [Información básica del COVID-19](https://nextstrain.org/ncov/europe/2020-05-01?d=tree&f_region=Europe&legend=closed)
...
#### Recursos Externos  
* [Como muta y se propaga el SARS-CoV-2](https://www.nytimes.com/interactive/2020/04/30/science/coronavirus-mutations.html).
* [Pregúntale a un Científico y Preguntas Frecuentes](https://covid19.fas.org/).
...
* [¿Porqué el Coronavirus es tan confuso?](https://www.theatlantic.com/health/archive/2020/04/pandemic-confusing-uncertainty/610819/).
...
# [Acerca del muestreo de datos](https://nextstrain.org/ncov/europe/2020-05-01?c=country&r=country&d=map&f_region=Europe&p=grid&legend=closed)
Actualmente tenemos secuencias virales de 6 continentes. Este es un logro increíble: secuenciar un virus de ARN desconocido y de gran tamaño durante una pandemia es difícil, y solo es posible gracias al increíble trabajo y al intercambio de datos por parte de científicos y médicos de todo el mundo.
<br><br>
WSi bien estos datos nos permiten inferir muchas características útiles del brote y seguir su propagación en tiempo real, es importante destacar que nuestras conclusiones se ven limitadas por los datos disponibles.
<br><br>
Por ejemplo, este mapa nos permite observar muchas muestras de Islandia, el Reino Unido y los Países Bajos. Esto no necesariamente indica que el SARS-CoV-2 esté circulando mas ampliamente por estas áreas; sino mas bien, que tenemos más información disponible de estos países. Nótese que el tamaño de cada círculo en el mapa indica la cantidad de datos disponibles actualmente de esa área, y no el tamaño real del brote.
...
<br><br>
Esto indica que la epidemia en Rusia fue desencadenada por varias introducciones independientes, en lugar de una única introducción seguida de propagación local.
<br><br>
Aunque hay pocas muestras hacia el fondo del árbol que se encuentren relacionadas a casos asiáticos, la mayoría de las muestras rusas descienden de linajes europeos.
...
<br><br>
Hay algunos cúmulos de casos que se encuentran relacionados a otras muestras de Moscú, indicando una posible transmisión local. Sin embargo, la mayoría de las muestras de Moscú están relacionadas con muestras de otros lugares, algo consistente con la importación.
<br><br>
Dado el número de casos confirmados en Moscú, es posible que algunas de estas introducciones hayan llevado a una propagación local, aunque aún no contamos con información suficiente para verlo.
...
<br><br>
Al igual que con Moscú, existen muestras de San Petersburgo todo a lo largo del árbol, indicando que también allí han habido múltiples introducciones.
En contraste, si haces clic en "Explora la información tu mismo" y haces zoom en el cúmulo centro de esta vista, podemos ver un gran clado compuesto enteramente de muestras de San Petersburgo.
<br><br>
Este patrón es consistente con una de estas introducciones de San Petersburgo comenzando una amplia transmisión alrededor de toda la ciudad a comienzos de la primera semana de Marzo. Este gran cúmulo de brotes está principalmente relacionado con muestras de Europa Occidental, aunque no puede descartarse la posibilidad de una transmisión intermedia de algún otro lugar no detectada en las muestras.
<!-- There is no right side text -->
...
<br><br>
Existen al menos 7 instancias donde una muestras aislada de la Rep. Checa desciende de un virus que muy probablemente se encontraba circulando en otra parte de Europa, indicando nuevas introducciones entre el 1 de Marzo y el 2 de Abril.
<br><br>
En 5 de estas introducciones, podemos también observar casos locales cercanos, muestreados a lo largo del tiempo. Esto es consistente con la transmisión local.
<br><br>
A partir de esto, podemos decir que hubo al menos 7 introducciones a la República Checa; de las cuales al menos 5 luego resultaron en transmisión local.
...
<br><br>
Normalmente, asumiríamos que viajeros que retornan han transmitido el virus a compañeros de hogar o vecinos en su lugar de origen.
Interesantemente, sin embargo, los casos de estos viajeros fueron frecuentemente muestreados en  provincias distintas que aquellas de los casos mas cercanos.
<br><br>
Esto indica que ha habido una mezcla extendida de linajes virales, alcanzando varias provincias de Turquía en la misma semana.
Podríamos especular también que una acumulación numerosa explicaría estas observaciones, aunque necesitaríamos información epidemiológica adicional para investigar aún más.
<!-- There is no right-side text -->
...
* Usa mascara (las hechas en casa funcionan bien) en público.
...
#### El SARS-COV-2 ha sido introducido a Rusia varias veces; el brote en Moscú es heterogéneo.
<br><br>
#### Observamos varias introducciones a San Petersburgo. Una de esas introducciones, que proviene de Europa Occidental en principios de marzo, empezó un gran cúmulo de casos de transmisión local.
<br><br>
#### Después de varias introducciones asociadas con viajes, apreciamos un mezcla extendida de casos a lo largo de Turquía
<br><br>
#### Apreciamos al menos 5 cadenas de transmisión local propagando a través de la la República Checa.
<br><br>
#### Observamos al menos 11 introducciones independientes del virus a Polonia.  
<br><br>
#### Hemos recibido muestras tempranas de Hungría, Lituania, Eslovaquia y Eslovenia. Aunque aún no tenemos información suficiente de estos países para sacar conclusiones en firme, aplaudimos estos tempranos esfuerzos y continuaremos monitoreando la información suministrada.
```
...
<br><br>
Las secuencias proporcionadas por cada laboratorio están listadas [aquí](https://github.com/nextstrain/ncov/blob/52a133354c70d712a99f2d2a62116defe0f605ff/narratives/sit-rep_credits.md).
<br><br>
