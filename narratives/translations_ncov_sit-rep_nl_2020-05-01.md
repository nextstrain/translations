---
title: Genomische analyse van COVID-19 verspreiding. Situatierapportage 01-05-2020.
authors:
  - Sidney Bell  
  - Nicola Müller
  - Cassia Wagner
...
date: 1 mei 2020
abstract: "Dit wekelijkse rapport maakt gebruik van openbaar gedeelde genomische gegevens om de verspreiding van COVID-19 te volgen. Deze week richten we ons op de uitbraakdynamiek in Centraal- en Oost-Europa."
---
...
# [Inhoudsopgave](https://nextstrain.org/ncov/europe/2020-05-01?d=map&f_region=Europe&legend=closed)

* [Achtergrondbronnen](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-01?n=2).     
* [Over deze data](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-01?n=3).
* [Updates voor Rusland](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-01?n=4).
* [Updates voor Tsjechië](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-01?n=7).
* [Updates voor Turkije](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-01?n=8).
* [Updates voor Polen](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-01?n=9).
* [Data van Hongarije, Slowakije, Slovenië en Letland](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-01?n=10).
* [Wat u kunt doen](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-01?n=11).
* [Wetenschappelijk dankwoord](https://nextstrain.org/narratives/ncov/sit-rep/nl/2020-05-01?n=12).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Samenvatting

We hebben 4442 openbaar gedeelde COVID-19-genomen geanalyseerd. Door deze virale genomen met elkaar te vergelijken, kunnen we karakteriseren hoe COVID-19 zich wereldwijd beweegt en lokaal verspreidt.
Deze week richten we ons op Centraal- en Oost-Europa en rapporteren: 

* Vele introducties in Rusland  
* Heterogene uitbraak in Moskou  
* Meerderheid van de uitbraak in Sint-Petersburg gerelateerd aan een enkele introductie, hoogstwaarschijnlijk vanuit West-Europa
* Wijdverspreide verstrengeling van gevallen binnen Turkije, als gevolg van herhaalde reisgerelateerde introducties  
* Minimaal 5 lokale transmissieketens in Tsjechië, waarschijnlijk door herhaaldelijke introducties vanuit West-Europa
* Minimaal 11 aparte introducties in Polen
* Vroege monsters vanuit Hongarije, Letland, Polen, Slowakije en Slovenië  
```
...
# [COVID-19 Bronnen](https://nextstrain.org/ncov/europe/2020-05-01?d=tree&f_region=Europe&legend=closed)
...
#### Externe Bronnen  
* [Hoe SARS-CoV-2 muteert en verspreidt (Engels)](https://www.nytimes.com/interactive/2020/04/30/science/coronavirus-mutations.html).
...
* [Waarom het coronavirus zo verwarrend is (Engels)](https://www.theatlantic.com/health/archive/2020/04/pandemic-confusing-uncertainty/610819/).
...
# [Een opmerking over bemonstering](https://nextstrain.org/ncov/europe/2020-05-01?c=country&r=country&d=map&f_region=Europe&p=grid&legend=closed)
We hebben momenteel sequenties van monsters genomen op 6 continenten. Dit is een ongelooflijke prestatie -- het sequencen van een onbekend, groot RNA-virus tijdens een pandemie is moeilijk en is alleen mogelijk door het ongelooflijke werk en het tijdig delen van gegevens door wetenschappers en artsen over de hele wereld.
<br><br>
...
<br><br>
Zo toont de kaart  bijvoorbeeld veel monsters vanuit Ijsland, het Verenigd Koninkrijk en Nederland. Dit betekent niet noodzakelijkerwijs dat SARS-CoV-2 meer wijdverspreid circuleert in in deze gebieden; we hebben gewoon meer data beschikbaar vanuit deze landen. De grootte van elke cirkel op de kaart geeft aan hoeveel gegevens er momenteel beschikbaar zijn uit dat gebied, in plaats van de ware grootte van de uitbraak.
<!-- There is NO right-side text -->
...
<br><br>
Dit geeft aan dat de epidemie in Rusland veroorzaakt is door vele afzonderlijke introducties, in plaats van een enkele introductie gevolgd door verspreiding binnen de landsgrenzen. 
<br><br>
Alhoewel er enkele monsters onder aan de boom zijn die nauw verwant zijn aan Aziatische gevallen, is de meerderheid van de Russische monsters afstammeling van Europese virusstammen.  
...
<br><br>
Er zijn enkele clusters van gevallen die het meest nauw verwant zijn met andere monsters uit Moskou, wat waarschijnlijk lokale transmissie aanduidt. 
Echter, de meeste monsters uit Moskou zijn nauw verwant met monsters van elders, consistent met externe introducties. 
<br><br>
Gegeven het aantal bevestigde gevallen in Moskou, is het waarschijnlijk dat in ieder geval enkele van deze introducties geleid hebben tot verdere locale verspreiding, maar we hebben nog niet genoeg data om dit te zien.  
...
<br> <br>
Net als bij Moskou zijn er over de hele boom monsters uit Sint-Petersburg te vinden, wat aangeeft dat er meerdere introducties zijn geweest.
Als u daarentegen op 'Explore the Data Yourself' ('Verken de gegevens zelf') klikt en inzoomt op het hoofdcluster in het midden van deze weergave, zien we een grote clade die volledig bestaat uit monsters uit St. Petersburg.
<br> <br>
Dit patroon komt overeen met uitbreiding van één van deze introducties in Sint-Petersburg, die wijdverspreide transmissie 
door de stad veroorzaakte, te beginnen rond de eerste week van maart. Dit grote uitbraakcluster is het nauwst verwant aan monsters uit West-Europa, hoewel we de mogelijkheid van een niet-bemonsterde, tussentijdse overdracht van elders niet kunnen uitsluiten.
<!-- There is no right side text -->
...
<br><br>
Er zijn minimaal zeven instanties waar een monster, geïsoleerd in Tsjechië, afstamt van een virus wat waarschijnlijk ergens anders in Europa circuleerde, wijzend op nieuwe introducties tussen 1 maart en 2 april. 
<br><br>
Voor 5 van deze introducties, zien we ook lokaal nauw verwante gevallen, bemonsterd door de tijd. Dit is consistent met lokale transmissie. 
<br><br>
Hieruit kunnen we concluderen dat er minimaal 7 introducties naar Tsjechië waren; minimaal 5 hiervan hebben waarschijnlijk geleid tot verdere lokale verspreiding. 
...
<br> <br>
Normaal gesproken zouden we kunnen aannemen dat terugkerende reizigers het virus hadden doorgegeven aan huisgenoten of buren thuis.
Interessant is echter dat de gevallen van reizigers vaak uit andere provincies werden bemonsterd dan de meest nauw verwante gevallen.
<br> <br>
Dit geeft aan dat er een uitgebreide menging van virale lijnen is geweest, die binnen een week veel provincies van Turkije heeft bereikt.
We kunnen ook speculeren dat een grote bijeenkomst deze waarnemingen zou kunnen verklaren, hoewel we aanvullende epidemiologische gegevens nodig zouden hebben om dit verder te onderzoeken.
<!-- There is no right-side text -->
...
#### SARS-COV-2 is vele keren in Rusland geïntroduceerd; Moskou's uitbraak is zeer heterogeen.
<br><br>
#### Er zijn meerdere introducties geweest in St. Petersburg. Één van deze introducties, begin maart vanuit West-Europa, leidde tot een groot aantal lokaal overgedragen gevallen.
<br> <br>
#### Na herhaalde reisgerelateerde introducties is er een uitgebreide en snelle verstrengeling van virale lijnen in heel Turkije geweest.
<br> <br>
#### Er zijn minstens 5 lokale transmissieketens die in Tsjechië circuleren.
<br> <br>
#### Er zijn minstens 11 afzonderlijke introducties van het virus in Polen.
<br> <br>
#### We hebben vroege monsters ontvangen uit Hongarije, Letland, Slowakije en Slovenië. Hoewel we nog niet over voldoende gegevens beschikken om conclusies te trekken, zullen we blijven monitoren en zo snel mogelijk updates verstrekken.
```
...
<br><br>
De specifieke sequenties die door ieder lab zijn verstrekt vind u [hier](https://github.com/nextstrain/ncov/blob/e8020ca13e420bb62e31acf9a07268bc08b11c63/narratives/sit-rep_credits.md).
<br><br>
