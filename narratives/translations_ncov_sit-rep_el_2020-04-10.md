...
* [ΞΕΚΙΝΗΣΤΕ ΕΔΩ: Πώς να ερμηνεύσετε ενά φυλογενετικό δέντρο](https://nextstrain.org/narratives/trees-background/). 
...
Εδώ επισημαίνουμε δείγματα από τα μέσα Δεκεμβρίου 2019 έως τα μέσα Ιανουαρίου 2020, κατά τον πρώτο μήνα της επιδημίας.
...
Αυτό συμβαδίζει με την διαδοση του ιού σε μεγάλο βαθμό εντός της Κίνας και μερικές περιπτώσεις εξαγωγής του σε άλλες χώρες της Ασίας τον πρώτο μήνα της επιδημίας.
<!-- There is no right side text -->
...
Αυτά τα πρώτα κρούσματα εξακολουθούν να ομαδοποιούνται με δείγματα από την Ασία και γενικά στερούνται χαρακτηριστικών γνωρισμάτων τοπικής μετάδοσης.
<br><br>
...
Έχουμε παρατηρήσει [σε προηγούμενη αναφορά](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-27?f_region=Europe&n=5) ένα παρόμοιο πρότυπο συχνής ανάμιξης ιογενών γραμμών μεταξύ των ευρωπαϊκών χωρών. 
<!-- There is no right side text -->
