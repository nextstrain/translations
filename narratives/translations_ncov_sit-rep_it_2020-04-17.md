...
abstract: "Questo rapporto usa le sequenze genomiche virali pubblicamente condivise per tracciare la diffusione del COVID-19. Questa settimana, il rapporto è focalizzato sull'epidemia negli Stati Uniti. Per la maggioranza delle zone negli Stati Uniti, abbiamo trovato prove di introduzioni multiple del virus di provenienza sia internaziole che domestica. Ciò sottolinea come le decisioni prese da un singolo Stato possano influenzare profondamente il destino degli altri."
---
...
* [Risorse di base](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-17?n=2).  
<!--* [About this data](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-17?n=3).-->
* [Una nota sulla raccolta dei campioni](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-17?n=3).
<!--* [Updates for New York](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-17?n=4).-->
* [Aggiornamenti su New York](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-17?n=4).
<!--* [Updates for California](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-17?n=7).-->
* [Aggiornamenti sulla California](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-17?n=7).
<!-- * [Updates for the Midwest](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-17?n=8).-->
* [Aggiornamenti sugli Stati Uniti del Midwest](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-17?n=8).
<!-- * [Updates for the Rocky Mountain West](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-17?n=9).-->
* [Aggiornamenti sugli Stati delle Montagne Rocciose](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-17?n=9).
<!--* [What you can do](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-17?n=10).-->
* [Cosa puoi fare](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-17?n=10).
<!-- * [Scientific credit](https://nextstrain.org/narratives/ncov/sit-rep/2020-04-17?n=11).-->
* [Riconoscimenti scientifici](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-17?n=11).
...
Abbiamo analizzato 1347 genomi condivisi pubblicamente del virus SARS-Cov-2 provenienti dagli Stati Uniti. Confrontando questi genomi virali tra loro, possiamo tracciare come il virus SARS-CoV-2 si sta spostando nel mondo e si sta diffondendo all'interno delle comunità. Questa settimana, riportiamo: 
...
* L'epidemia negli Stati Uniti del Midwest è etereogenea ed è il risultato di molteplici introduzioni indipendenti del virus. 
...
* Le decisioni prese dai singoli Stati hanno un profondo impatto sul destino degli altri. Un rilassamento in sicurezza delle misure di restrizione in atto in ogni Stato richiederà un contenimento coordinato con tutti gli Stati che agiscono per proteggersi l'un l'altro.
...
# [Il ramo principale di New York è legato al focolaio europeo](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_division=Europe,New%20York&label=clade:A2&p=full&r=country)
...
Il ramo di New York è affiancato e intervallato da sequenze del virus provenienti dall'Europa, il che suggerisce fortemente che la maggior parte dei primi casi deriva da introduzioni del virus dall'Europa.
<!-- There is no right side text -->
...
# [Introduzioni multiple del virus a New York](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree&f_division=Europe,New%20York,Asia&label=clade:A2&p=grid&r=location)
...
La maggior parte dei focolai di New York sono derivati da introduzioni del virus dall'Europa; tuttavia le sequenze dello stesso periodo provenienti da altre regioni del mondo ci consentono di vedere che ci sono state ulteriori introduzioni a New York City. Fedelmente alla sua natura cosmopolita, ci sono casi a New York strettamente correlati a sequenze provenienti da ogni parte del mondo.
<br><br>
...
I primi casi a New York rappresentano probabilmente trasmissioni in entrata. Successivamente, vediamo molti più mix tra campioni europei e newyorkesi, e ciò rende la comprensione della direzione delle trasmissioni successive meno chiara.
Come abbiamo riportato [la settimana scorsa](https://nextstrain.org/narratives/ncov/sit-rep/it/2020-04-10?n=11), ci sono prove di reintroduzione del virus dagli Stati Uniti in Europa e in Asia.
<!-- There is no right side text -->
...
# [Mescolamento dei casi tra tutti e 5 i distretti di New York](https://nextstrain.org/ncov/north-america/2020-04-17?c=location&d=tree,map&f_division=New%20York&f_location=Bronx,Brooklyn,Queens,Staten%20Island,Manhattan&label=clade:A2&p=full&r=location)
...
# [Il focolaio della California è collegato a Stati sia vicini che lontani](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&f_division=California,New%20York,Washington&r=division&d=tree,map&legend=closed)
...
Ci sono anche prove di introduzioni multiple tra Stati. Ad esempio, i casi della California coprono tutta la diversità genetica dell'albero, e si raggruppano con sequenze che vengono da zone circostanti Washington e New York. Ciò prova l'esistenza di una trasmissione tra la California e Stati vicini e lontani. 
...
# [I focolai del Midwest sono stati originati da molteplici introduzioni](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_country=USA&f_division=Illinois,Indiana,Iowa,Kansas,Michigan,Minnesota,Nebraska,Ohio,Wisconsin&p=full&r=division)
...
Se evidenziamo le sequenze provenienti dalla regione centro-occidentale degli Stati Uniti, notiamo che i casi si distribuiscono in modo uniforme piuttosto che formare una serie di gruppi strettamente legati. Questo ci dice che ci potrebbero essere state molte introduzioni indipendenti in questi Stati, con numerose catene di trasmissione diverse che circolavano simultaneamente.
...
# [Focolai correlati attraversano le Montagne Rocciose occidentali](https://nextstrain.org/ncov/north-america/2020-04-17?c=division&d=tree,map&f_country=USA&f_division=Idaho,Utah&label=clade:A2&m=div&p=full&r=division)
...
Ci sono anche state numerose introduzioni nella zona delle Montagne Rocciose occidentali. Se ci avviciniamo, vediamo una chiara catena di trasmissione che si diffonde attraverso l'Idaho. In particolare, questo insieme di casi è accompagnato da un gruppo di casi dallo Utah, che dimostra che esiste una stretta relazione tra questi due focolai.
...
* Indossare la mascherina in pubblico.
...
* Stai a casa il più possibile -- specialmente se sei malato; prepara delle provviste extra nel caso dovessi metterti in quarantina. 
...
*  Le introduzioni del virus dall'Europa hanno generato la maggior parte dell'epidemia di New York, ma ci sono state anche introduzioni del virus da altre aree del mondo.
<br><br>
<!-- * As the outbreak has progressed, we also see evidence for re-introductions from the U.S. to Europe and Asia.-->
* Col progredire dell'epidemia, abbiamo osservato casi reintroduzioni del virus dagli Stati Uniti in Europa e in Asia.
<br><br>
<!-- * The outbreak in New York City shows mixing of cases across all 5 boroughs.-->
* I focolai a New York City mostrano un mix di casi tra tutti e 5 i distretti.
<br><br>
<!-- * The outbreak in California is related to both nearby Washington State and distant New York.-->
* L'epidemia in California è legata sia al vicino Stato di Washington che alla lontana New York.
<br><br>
<!-- * The Midwest outbreak is heterogeneous, with multiple transmission chains circulating in the region.-->
* L'epidemia nel Midwest è etereogenea, con multiple catene di trasmissione del virus circolanti nella regione.
<br><br>
<!--  * Outbreaks in Utah and Idaho are closely related, with ongoing community transmission.-->
* I focolai in Utah and Idaho sono strettamente connessi, con trasmissione nella comunità in corso.
<br><br>
<!-- * The decisions made by each state profoundly impacts the fate of the others. Safely easing restrictions in any state will require coordinated containment, with all states acting to protect each other.  -->
* Le decisioni prese dai singoli Stati hanno un profondo impatto sul destino degli altri. Un rilassamento in sicurezza delle misure di restrizione in atto in ogni Stato richiederà un contenimento coordinato con tutti gli Stati che agiscono per proteggersi l'un l'altro.
```
...
# [Riconoscimenti scientifici](https://nextstrain.org/ncov/north-america/2020-04-17?d=map&c=author)
...
Questi dati sono stati condivisi tramite [GISAID](https://gisaid.org), che ringraziamo per i loro contributi.

<br>

<!-- To the right we give specific sequences shared by each lab.-->
Sulla destra le sequenze specifiche condivise da ciascun laboratorio.

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown

<!-- The SARS-CoV-2 genomes were generously shared by scientists at these submitting labs:-->
I genomi di SARS-CoV-2 sono stati generosamente condivisi da scienziati di questi laboratori:
