---
title: Γονιδιωματική ανάλυση της εξάπλωσης του COVID-19. Αναφορά κατάστασης 08/05/2020.
authors:
  - Cassia Wagner
  - Sidney M. Bell
  - Nicola Müller
...
abstract: "Aυτή η εβδομαδιαία αναφορά χρησιμοποιεί δεδομένα που είναι δημοσίως διαθέσιμα για την ιχνηλάτηση της εξάπλωσης της ασθένειας COVID-19. Αυτή την εβδομάδα εστιάζουμε στην Ασία. Αναφέρουμε πολλές ξεχωριστές και ανεξάρτητες μεταξύ τους εισαγωγές στην Ινδία, διασπορά του ιού σε εργαζόμενους μετανάστες στη Σιγκαπούρη και επιπολασμό της διεθνούς διασποράς του ιού σε ολόκληρη την περιοχή."
---
...
* [Εισαγωγές στη Μαλαισία](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-05-08?n=6). 
* [Συχνές διασπορές σε διεθνή σύνορα](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-05-08?n=7).
* [Επιστημονικές ευχαριστίες](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-05-08?n=8).
...
* Πολλαπλές εισαγωγές στο Δελχί το Μάρτιο του 2020 από όλον τον κόσμο 
* Πολλές ξεχωριστές εισαγωγές στη Σιγκαπούρη, οι περισσότερες από τις οποίες δε φαίνεται να έχουν εξαπλωθεί περαιτέρω
* Eπέκταση ενός συμπλέγματος κρουσμάτων στη Σιγκαπούρη που πιθανώς οφείλεται σε κοινωνικούς παράγοντες
* Παρόμοια μοτίβα διεθνούς εξάπλωσης που τονίζουν την επείγουσα ανάγκη για προσπάθειες συνεργασίας
```
...
# [COVID-19 Πηγές](https://nextstrain.org/ncov/asia/2020-05-08?d=tree&p=full&legend=closed&f_region=Asia)
...
* [Κάλυψη του COVID-19 από τους NYTimes](https://www.nytimes.com/news-event/coronavirus).
...
# [Μια σημείωση σχετικά με τις δειγματοληψίες](https://nextstrain.org/ncov/asia/2020-05-08?c=country&r=country&d=map&p=grid&legend=closed)
...
<br><br>
Παρόλο που τα δεδομένα αυτά μας επιτρέπουν να αντιληφθούμε πολλά και χρήσιμα χαρακτηριστικά για την επιδήμια και να παρακολουθήσουμε την εξάπλωσή της σε πραγματικό χρόνο, είναι σημαντικό να επισημάνουμε ότι τα συμπερασματά μας περιορίζονται απο τη διαθεσιμότητα των δεδομένων. 
<br><br>
Για παράδειγμα στο χάρτης αυτόν βλέπουμε πολύ λίγα δείγματα από την Μέση Ανατολή. Αυτό ΔΕΝ οφείλεται στο γεγονός ότι ο COVID-19 δεν κυκλοφορεί σε αυτές τις περιοχές ή ότι αυτές οι περιπτώσεις δεν είναι τόσο σημαντικές για να τις κατανοήσουμε, αλλά ότι δεν έχουμε διαθέσιμα δεδομένα από αυτές τις περιοχές. Το μέγεθος κάθε κύκλου στο χάρτη δείχνει πόσα δεδομένα είναι διαθέσιμα αυτήν τη στιγμή από τις αντίστοιχες περιοχές και όχι το πραγματικό μέγεθος της επιδημίας στις περιοχές αυτές.
...
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Πολλές ξεχωριστές εισαγωγές στο Δελχί το Μάρτιο](https://nextstrain.org/ncov/asia/2020-05-08?c=division&d=tree,map&dmax=2020-04-15&dmin=2020-03-01&f_country=India&f_division=Delhi&p=full&r=country&m=div)

Μεταξύ 1 Μαρτίου και 15 Απριλίου έγιναν δειγματοληψίες και αλληλούχηση σε 38 ιικά γονιδιώματα από την περιοχή του Δελχί (όπως φαίνεται εδώ).
<br><br>
Στη μέση του δέντρου βλέπουμε ένα αρκετά μεγάλο σύμπλεγμα στενά συνδεδεμένων κρουσμάτων. Αυτό είναι σύμφωνο με το γεγονός μίας εισαγωγής, ακολουθούμενη από εξάπλωση στην τοπική κοινότητα.
<br><br>
Ωστόσο, είναι σημαντικό να εξετάσουμε το ευρύτερο πλαίσιο αυτού του συμπλέγματος κρουσμάτων. Παρατηρούμε πολλές μικρές συστάδες αλλά και μεμονωμένα κρούσματα διασκορπισμένα στο δέντρο που αντιπροσωπεύουν ξεχωριστές εισαγωγές από όλο τον κόσμο. Δεν έχουμε όμως αρκετά δεδομένα για να κατανοήσουμε τι ακολούθησε αυτές τις εισαγωγές -- εάν ή και πόσο μακριά εξαπλώθηκαν. Όμως, μπορούμε να πούμε ότι το μεγάλο σύμπλεγμα κρουσμάτων είναι μόνο ένα μέρος της ιστορίας.
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Ευρύτερο πλαίσιο της επανεμφάνισης SARS-CoV-2 στη Σιγκαπούρη](https://nextstrain.org/ncov/asia/2020-05-08?d=tree,map&dmin=2020-02-26&f_country=China,Singapore,India,Philippines&p=full&legend=closed&r=division)

Τις τελευταίες 10 εβδομάδες ο SARS-CoV-2 έχει εισαχθεί στη Σιγκαπούρη πολλές φορές και από πολλές τοποθεσίες.
<br><br>
Οι περισσότερες από αυτές τις εισαγωγές οδήγησαν σε περιορισμένη μετάδοση (μεμονωμένα κρούσματα ή μικρά συμπλέγματα κρουσμάτων στο δέντρο).
<br><br>
Ωστόσο, στη μέση του δέντρου βλέπουμε μια εισαγωγή που οδήγησε σε εκτεταμένη διασπορά του ιού.
Αυτό το μεγάλο και συνεκτικό σύμπλεγμα σχετίζεται στενότερα με δείγματα από την Ινδία και τις Φιλιππίνες.
<br><br>
Το γεγονός αυτό συμβαδίζει με [πρόσφατες αναφορές στα νέα](https://www.nytimes.com/interactive/2020/04/28/world/asia/coronavirus-singapore-migrants.html) ότι ο ιός εξαπλώθηκε γρήγορα σε ευάλωτους και περιορισμένους πληθυσμούς εργαζόμενων μεταναστών στη Σιγκαπούρη.
<br><br>
Αυτό δείχνει πως ο βαθμός με τον οποίο εξαπλώνεται μια εισαγωγή του ιού σε έναν πληθυσμό εξαρτάται από κοινωνικούς παράγοντες και καταδεικνύει τη σημασία της προστασίας των ευάλωτων ομάδων.
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Επαναλαμβανόμενες εισαγωγές στη Μαλαισία](https://nextstrain.org/ncov/asia/2020-05-08?f_country=Malaysia&d=tree,map&r=division)

Έχουμε 14 αλληλουχίες από τη Μαλαισία στο Nextstrain, δείγματα μεταξύ τέλους Ιανουαρίου και τέλους Μαρτίου. Αυτές οι αλληλουχίες ομαδοποιούνται σε πολλά διαφορετικά κλαδιά, καθένα από τα οποία αντιστοιχούν σε κυκλοφορία του ιού κυρίως σε άλλες ασιατικές χώρες. Αυτό υποδηλώνει ότι έχουν γίνει πολλές εισαγωγές στη Μαλαισία από τις γύρω περιοχές.


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text -->
# [Τοπικές διασπορές του ιού σε ολόκληρη την Ασία](https://nextstrain.org/ncov/asia/2020-05-08?d=tree,map&f_country=Japan,Jordan,Thailand,United%20Arab%20Emirates)

Ένα παρόμοιο μοτίβο επαναλαμβάνεται σε πολλές άλλες χώρες της περιοχής: πολλαπλές εισαγωγές, πολλές από τις οποίες περιορίστηκαν, όμως άλλες πυροδότησαν τοπική διασπορά του ιού. Σας ενθαρρύνουμε να "Εξερευνήσετε τα δεδομένα". Όπως φαίνεται εδώ, παρατηρούμε παρόμοια μοτίβα στην Ιορδανία, την Ιαπωνία, την Ταϊλάνδη και τα Ηνωμένα Αραβικά Εμιράτα. Παρόμοια μοτίβα φαίνονται επίσης για το Κουβέιτ, τη Γεωργία, την Ταϊβάν και το Βιετνάμ
<br><br>
Η επανάληψη αυτού του μοτίβου αποδεικνύει πως ο ιός διασχίζει συχνά διεθνή σύνορα. Έτσι, για να περιορίσουμε αποτελεσματικά την επιδημία σε οποιαδήποτε χώρα θα πρέπει να περιορίσουμε την πανδημία σε όλες τις χώρες μέσω συντονισμένων διεθνών προσπαθειών.
<!-- There is no right side text -->
...
#### Η επιδημία στην Ινδία είναι αποτέλεσμα πολλών ξεχωριστών εισαγωγών από όλο τον κόσμο.  
<br><br>
#### Στη Σιγκαπούρη οι κοινωνικοί παράγοντες επιτάχυναν την επέκταση μιας εισαγωγής με αποτέλεσμα τη μεγάλη διασπορά του ιού, σε αντίθεση με τις πολλαπλές εισαγωγές οι οποίες δε φαίνεται να έχουν εξαπλωθεί ευρέως.
<br><br>
#### Στην Ασία οι τοπικές επιδημίες έχουν παρόμοια ιστορία: πολλές ξεχωριστές εισαγωγές από άλλες χώρες, μερικές από τις οποίες είχαν ως αποτέλεσμα την τοπική διασπορά. Αυτό το μοτίβο πολλαπλών εισαγωγών στην πάροδο του χρόνου τονίζει την ανάγκη διεθνούς και τοπικής συνεργασίας για τον πλήρη έλεγχο της πανδημίας.
```
